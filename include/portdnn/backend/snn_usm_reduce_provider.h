 ...
 */
#ifndef PORTDNN_INCLUDE_BACKEND_SNN_USM_REDUCE_PROVIDER_H_
#define PORTDNN_INCLUDE_BACKEND_SNN_USM_REDUCE_PROVIDER_H_
...
#endif  // PORTDNN_INCLUDE_BACKEND_SNN_USM_REDUCE_PROVIDER_H_
