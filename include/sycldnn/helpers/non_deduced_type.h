 ...
 */
#ifndef SYCLDNN_INCLUDE_HELPERS_NON_DEDUCED_TYPE_H_
#define SYCLDNN_INCLUDE_HELPERS_NON_DEDUCED_TYPE_H_
 ...
 *
 * Many functions in SYCL-DNN are templated, with most of the function
...
#endif  // SYCLDNN_INCLUDE_HELPERS_NON_DEDUCED_TYPE_H_
