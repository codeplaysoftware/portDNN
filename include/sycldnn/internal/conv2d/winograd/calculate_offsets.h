 ...
 */
#ifndef SYCLDNN_INCLUDE_INTERNAL_CONV2D_WINOGRAD_CALCULATE_OFFSETS_H_
#define SYCLDNN_INCLUDE_INTERNAL_CONV2D_WINOGRAD_CALCULATE_OFFSETS_H_
...
#endif  // SYCLDNN_INCLUDE_INTERNAL_CONV2D_WINOGRAD_CALCULATE_OFFSETS_H_
