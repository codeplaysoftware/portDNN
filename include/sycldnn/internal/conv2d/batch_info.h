 ...
 */
#ifndef SYCLDNN_INCLUDE_INTERNAL_CONV2D_BATCH_INFO_H_
#define SYCLDNN_INCLUDE_INTERNAL_CONV2D_BATCH_INFO_H_
...
#endif  // SYCLDNN_INCLUDE_INTERNAL_CONV2D_BATCH_INFO_H_
