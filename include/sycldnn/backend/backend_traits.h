 ...
 */
#ifndef SYCLDNN_INCLUDE_BACKEND_BACKEND_TRAITS_H_
#define SYCLDNN_INCLUDE_BACKEND_BACKEND_TRAITS_H_
 ...
 * T used in the external interface of SYCL-DNN.
...
#endif  // SYCLDNN_INCLUDE_BACKEND_BACKEND_TRAITS_H_
