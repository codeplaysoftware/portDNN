 ...
 */
#ifndef SYCLDNN_INCLUDE_BACKEND_CRTP_BACKEND_H_
#define SYCLDNN_INCLUDE_BACKEND_CRTP_BACKEND_H_
 ...
 * providers which make up the SYCL-DNN backends.
 *
...
#endif  // SYCLDNN_INCLUDE_BACKEND_CRTP_BACKEND_H_
