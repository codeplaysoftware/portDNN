 ...
 */
#ifndef SYCLDNN_INCLUDE_BACKEND_DEVICE_MEM_POINTER_H_
#define SYCLDNN_INCLUDE_BACKEND_DEVICE_MEM_POINTER_H_
...
#endif  // SYCLDNN_INCLUDE_BACKEND_DEVICE_MEM_POINTER_H_
