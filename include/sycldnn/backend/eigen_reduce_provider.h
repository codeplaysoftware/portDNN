 ...
 */
#ifndef SYCLDNN_INCLUDE_BACKEND_EIGEN_REDUCE_PROVIDER_H_
#define SYCLDNN_INCLUDE_BACKEND_EIGEN_REDUCE_PROVIDER_H_
...
#endif  // SYCLDNN_INCLUDE_BACKEND_EIGEN_REDUCE_PROVIDER_H_
