...
#ifndef SYCLDNN_INCLUDE_COMPAT_POOLING_HPP
#define SYCLDNN_INCLUDE_COMPAT_POOLING_HPP
 ...
 public:
  ...
  sycldnn::StatusCode set2d(
    ...
    SNN_VALIDATE_PARAM(
        ...
        "Sycldnn only supports average pooling with padding excluded.");
    SNN_VALIDATE_PARAM(mode != PoolingMode::POOLING_MAX,
                       "Sycldnn only supports deterministic max pooling.");
