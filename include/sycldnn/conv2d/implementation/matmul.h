 ...
 */
#ifndef SYCLDNN_INCLUDE_CONV2D_IMPLEMENTATION_MATMUL_H_
#define SYCLDNN_INCLUDE_CONV2D_IMPLEMENTATION_MATMUL_H_
...
#endif  // SYCLDNN_INCLUDE_CONV2D_IMPLEMENTATION_MATMUL_H_
