...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x2x2x2x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {288., 304., 320., 336., 420., 440., 460., 480.};
  const std::array<int, 4> in_shape = {{ 1, 2, 2, 2 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x2x2x4x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {524., 552., 640., 672., 772., 808., 920., 960.};
  const std::array<int, 4> in_shape = {{ 1, 2, 2, 4 }};
  const int multiplier = 2;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x2x2x4x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {1020., 1048., 1076., 1104., 1248., 1280., 1312., 1344., 1508., 1544., 1580., 1616., 1800., 1840., 1880., 1920.};
  const std::array<int, 4> in_shape = {{ 1, 2, 2, 4 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x2x3x2x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {1036., 1072., 1108., 1144., 1330., 1372., 1414., 1456.};
  const std::array<int, 4> in_shape = {{ 1, 2, 3, 2 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x2x3x4x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {1946., 2012., 2216., 2288., 2510., 2588., 2828., 2912.};
  const std::array<int, 4> in_shape = {{ 1, 2, 3, 4 }};
  const int multiplier = 2;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x2x3x4x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {3826., 3892., 3958., 4024., 4360., 4432., 4504., 4576., 4942., 5020., 5098., 5176., 5572., 5656., 5740., 5824.};
  const std::array<int, 4> in_shape = {{ 1, 2, 3, 4 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x2x4x2x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {2528., 2592., 2656., 2720., 3048., 3120., 3192., 3264.};
  const std::array<int, 4> in_shape = {{ 1, 2, 4, 2 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x2x4x4x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {4824., 4944., 5312., 5440., 5832., 5968., 6384., 6528.};
  const std::array<int, 4> in_shape = {{ 1, 2, 4, 4 }};
  const int multiplier = 2;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x2x4x4x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = { 9528.,  9648.,  9768.,  9888., 10496., 10624., 10752., 10880., 11528., 11664., 11800., 11936., 12624., 12768., 12912., 13056.};
  const std::array<int, 4> in_shape = {{ 1, 2, 4, 4 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x3x3x2x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {3633., 3714., 3795., 3876., 4290., 4380., 4470., 4560.};
  const std::array<int, 4> in_shape = {{ 1, 3, 3, 2 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x3x3x4x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {6969., 7122., 7590., 7752., 8247., 8418., 8940., 9120.};
  const std::array<int, 4> in_shape = {{ 1, 3, 3, 4 }};
  const int multiplier = 2;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x3x3x4x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {13785., 13938., 14091., 14244., 15018., 15180., 15342., 15504., 16323., 16494., 16665., 16836., 17700., 17880., 18060., 18240.};
  const std::array<int, 4> in_shape = {{ 1, 3, 3, 4 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x3x4x2x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = { 8768.,  8912.,  9056.,  9200.,  9932., 10088., 10244., 10400.};
  const std::array<int, 4> in_shape = {{ 1, 3, 4, 2 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x3x4x4x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {16996., 17272., 18112., 18400., 19276., 19576., 20488., 20800.};
  const std::array<int, 4> in_shape = {{ 1, 3, 4, 4 }};
  const int multiplier = 2;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x3x4x4x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {33716., 33992., 34268., 34544., 35936., 36224., 36512., 36800., 38252., 38552., 38852., 39152., 40664., 40976., 41288., 41600.};
  const std::array<int, 4> in_shape = {{ 1, 3, 4, 4 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x4x4x2x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {21056., 21312., 21568., 21824., 23120., 23392., 23664., 23936.};
  const std::array<int, 4> in_shape = {{ 1, 4, 4, 2 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x4x4x4x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {41136., 41632., 43136., 43648., 45200., 45728., 47328., 47872.};
  const std::array<int, 4> in_shape = {{ 1, 4, 4, 4 }};
  const int multiplier = 2;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME1x4x4x4x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {33648., 34144., 34640., 35136., 36608., 37120., 37632., 38144., 39696., 40224., 40752., 41280., 42912., 43456., 44000., 44544.};
  const std::array<int, 4> in_shape = {{ 1, 4, 4, 4 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x2x3x2x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {30108., 30432., 30756., 31080., 32718., 33060., 33402., 33744.};
  const std::array<int, 4> in_shape = {{ 3, 2, 3, 2 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 2048.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x2x3x4x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {41822., 42452., 44104., 44752., 46458., 47124., 48884., 49568.};
  const std::array<int, 4> in_shape = {{ 3, 2, 3, 4 }};
  const int multiplier = 2;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 128.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x2x3x4x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {34886., 35516., 36146., 36776., 38408., 39056., 39704., 40352., 42074., 42740., 43406., 44072., 45884., 46568., 47252., 47936.};
  const std::array<int, 4> in_shape = {{ 3, 2, 3, 4 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 128.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x2x4x2x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {31008., 31584., 32160., 32736., 34616., 35216., 35816., 36416.};
  const std::array<int, 4> in_shape = {{ 3, 2, 4, 2 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 128.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x2x4x4x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {21896., 22512., 23872., 24512., 25944., 26608., 28112., 28800.};
  const std::array<int, 4> in_shape = {{ 3, 2, 4, 4 }};
  const int multiplier = 2;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 64.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x2x4x4x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {17320., 17936., 18552., 19168., 20480., 21120., 21760., 22400., 23832., 24496., 25160., 25824., 27376., 28064., 28752., 29440.};
  const std::array<int, 4> in_shape = {{ 3, 2, 4, 4 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 64.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x3x3x2x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {42209., 42938., 43667., 44396., 46660., 47416., 48172., 48928.};
  const std::array<int, 4> in_shape = {{ 3, 3, 3, 2 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 128.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x3x3x4x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {22959., 23686., 25190., 25944., 27529., 28310., 29976., 30784.};
  const std::array<int, 4> in_shape = {{ 3, 3, 3, 4 }};
  const int multiplier = 2;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 64.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x3x3x4x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {19335., 20062., 20789., 21516., 23002., 23756., 24510., 25264., 26885., 27666., 28447., 29228., 30984., 31792., 32600., 33408.};
  const std::array<int, 4> in_shape = {{ 3, 3, 3, 4 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 64.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x3x4x2x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {32672., 33712., 34752., 35792., 37956., 39032., 40108., 41184.};
  const std::array<int, 4> in_shape = {{ 3, 3, 4, 2 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 64.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x3x4x4x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {34668., 35688., 37760., 38816., 40996., 42088., 44376., 45504.};
  const std::array<int, 4> in_shape = {{ 3, 3, 4, 4 }};
  const int multiplier = 2;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 64.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x3x4x4x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {28380., 29400., 30420., 31440., 33504., 34560., 35616., 36672., 38916., 40008., 41100., 42192., 44616., 45744., 46872., 48000.};
  const std::array<int, 4> in_shape = {{ 3, 3, 4, 4 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 64.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x4x4x2x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {41152., 42432., 43712., 44992., 47856., 49184., 50512., 51840.};
  const std::array<int, 4> in_shape = {{ 3, 4, 4, 2 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 64.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x4x4x4x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {11280., 12000., 13440., 14208., 15792., 16608., 18336., 19200.};
  const std::array<int, 4> in_shape = {{ 3, 4, 4, 4 }};
  const int multiplier = 2;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 32.0;
...
TYPED_TEST(FilterBackpropWindow1Stride1, SAME3x4x4x4x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = { 7248.,  7968.,  8688.,  9408., 10752., 11520., 12288., 13056., 14640., 15456., 16272., 17088., 18912., 19776., 20640., 21504.};
  const std::array<int, 4> in_shape = {{ 3, 4, 4, 4 }};
  const int multiplier = 4;
  const auto padding = sycldnn::PaddingMode::SAME;
  const DataType max_input_val = 32.0;
