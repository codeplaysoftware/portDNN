...
using MaxWindow5Stride2 = PoolingFixture<DataType>;
TYPED_TEST_CASE(MaxWindow5Stride2, types::GTestKernelDataTypes);
TYPED_TEST(MaxWindow5Stride2, SAME1x7x7x1) {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x7x7x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x7x7x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, VALID1x7x7x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x7x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x7x7x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x7x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, VALID1x7x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x7x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x7x8x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x7x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x7x8x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x7x10x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, VALID1x7x10x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x7x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x7x10x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x7x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x7x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, SAME1x8x7x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, VALID1x8x7x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {33., 35., 47., 49.};
  const std::array<int, 4> in_shape = {{1, 8, 7, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x8x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x8x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {65., 66., 69., 70.,
                                         93., 94., 97., 98.};
  const std::array<int, 4> in_shape = {{1, 8, 7, 2}};
...
TYPED_TEST(MaxWindow5Stride2, SAME1x8x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x8x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {129., 130., 131., 132., 137., 138.,
                                         139., 140., 185., 186., 187., 188.,
                                         193., 194., 195., 196.};
...
TYPED_TEST(MaxWindow5Stride2, SAME1x8x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, VALID1x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {37., 39., 53., 55.};
  const std::array<int, 4> in_shape = {{1, 8, 8, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {73.,  74.,  77.,  78.,
                                         105., 106., 109., 110.};
  const std::array<int, 4> in_shape = {{1, 8, 8, 2}};
...
TYPED_TEST(MaxWindow5Stride2, SAME1x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {145., 146., 147., 148., 153., 154.,
                                         155., 156., 209., 210., 211., 212.,
                                         217., 218., 219., 220.};
...
TYPED_TEST(MaxWindow5Stride2, SAME1x8x10x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, VALID1x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {45., 47., 49., 65., 67., 69.};
  const std::array<int, 4> in_shape = {{1, 8, 10, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {89.,  90.,  93.,  94.,  97.,  98.,
                                         129., 130., 133., 134., 137., 138.};
  const std::array<int, 4> in_shape = {{1, 8, 10, 2}};
...
TYPED_TEST(MaxWindow5Stride2, SAME1x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      177., 178., 179., 180., 185., 186., 187., 188., 193., 194., 195., 196.,
      257., 258., 259., 260., 265., 266., 267., 268., 273., 274., 275., 276.};
...
TYPED_TEST(MaxWindow5Stride2, SAME1x10x7x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, VALID1x10x7x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x10x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x10x7x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x10x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      93.,  94.,  95.,  96.,  101., 102., 103., 104., 109., 110., 111., 112.,
...
TYPED_TEST(MaxWindow5Stride2, VALID1x10x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, SAME1x10x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, VALID1x10x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x10x8x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, SAME1x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID1x10x10x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME1x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  71.,  72.,  75.,  76.,  79.,  80.,  79.,  80.,
      107., 108., 111., 112., 115., 116., 119., 120., 119., 120.,
...
TYPED_TEST(MaxWindow5Stride2, VALID1x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {89.,  90.,  93.,  94.,  97.,  98.,
                                         129., 130., 133., 134., 137., 138.,
...
TYPED_TEST(MaxWindow5Stride2, SAME1x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 141., 142., 143., 144., 149., 150., 151., 152.,
      157., 158., 159., 160., 157., 158., 159., 160., 213., 214., 215., 216.,
...
TYPED_TEST(MaxWindow5Stride2, VALID1x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      177., 178., 179., 180., 185., 186., 187., 188., 193., 194., 195., 196.,
      257., 258., 259., 260., 265., 266., 267., 268., 273., 274., 275., 276.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x7x7x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x7x7x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME3x7x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x7x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, SAME3x7x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x7x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      129., 130., 131., 132., 137., 138., 139., 140., 185., 186., 187., 188.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x7x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x7x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME3x7x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x7x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, SAME3x7x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x7x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      145., 146., 147., 148., 153., 154., 155., 156., 209., 210., 211., 212.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x7x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x7x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {45.,  47.,  49.,  65.,  67.,  69.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x7x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x7x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, SAME3x7x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      93.,  94.,  95.,  96.,  101., 102., 103., 104., 109., 110., 111., 112.,
      117., 118., 119., 120., 117., 118., 119., 120., 173., 174., 175., 176.,
...
TYPED_TEST(MaxWindow5Stride2, VALID3x7x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      177., 178., 179., 180., 185., 186., 187., 188., 193., 194., 195., 196.,
      257., 258., 259., 260., 265., 266., 267., 268., 273., 274., 275., 276.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x8x7x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x8x7x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME3x8x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x8x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, SAME3x8x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      93.,  94.,  95.,  96.,  101., 102., 103., 104., 109., 110., 111., 112.,
      109., 110., 111., 112., 149., 150., 151., 152., 157., 158., 159., 160.,
...
TYPED_TEST(MaxWindow5Stride2, VALID3x8x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      129., 130., 131., 132., 137., 138., 139., 140., 185., 186., 187., 188.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x8x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow5Stride2, SAME3x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, SAME3x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      109., 110., 111., 112., 117., 118., 119., 120., 125., 126., 127., 128.,
      125., 126., 127., 128., 173., 174., 175., 176., 181., 182., 183., 184.,
...
TYPED_TEST(MaxWindow5Stride2, VALID3x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      145., 146., 147., 148., 153., 154., 155., 156., 209., 210., 211., 212.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {45.,  47.,  49.,  65.,  67.,  69.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      89.,  90.,  93.,  94.,  97.,  98.,  129., 130., 133., 134., 137., 138.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 141., 142., 143., 144., 149., 150., 151., 152.,
      157., 158., 159., 160., 157., 158., 159., 160., 213., 214., 215., 216.,
...
TYPED_TEST(MaxWindow5Stride2, VALID3x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      177., 178., 179., 180., 185., 186., 187., 188., 193., 194., 195., 196.,
      257., 258., 259., 260., 265., 266., 267., 268., 273., 274., 275., 276.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x10x7x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      24.,  26.,  28.,  28.,  38.,  40.,  42.,  42.,  52.,  54.,  56.,  56.,
...
TYPED_TEST(MaxWindow5Stride2, VALID3x10x7x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {33.,  35.,  47.,  49.,  61.,  63.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x10x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      47.,  48.,  51.,  52.,  55.,  56.,  55.,  56.,  75.,  76.,  79.,  80.,
      83.,  84.,  83.,  84.,  103., 104., 107., 108., 111., 112., 111., 112.,
...
TYPED_TEST(MaxWindow5Stride2, VALID3x10x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, SAME3x10x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      93.,  94.,  95.,  96.,  101., 102., 103., 104., 109., 110., 111., 112.,
      109., 110., 111., 112., 149., 150., 151., 152., 157., 158., 159., 160.,
...
TYPED_TEST(MaxWindow5Stride2, VALID3x10x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      129., 130., 131., 132., 137., 138., 139., 140., 185., 186., 187., 188.,
      193., 194., 195., 196., 241., 242., 243., 244., 249., 250., 251., 252.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      28.,  30.,  32.,  32.,  44.,  46.,  48.,  48.,  60.,  62.,  64.,  64.,
...
TYPED_TEST(MaxWindow5Stride2, VALID3x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {37.,  39.,  53.,  55.,  69.,  71.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  59.,  60.,  63.,  64.,  63.,  64.,  87.,  88.,  91.,  92.,
      95.,  96.,  95.,  96.,  119., 120., 123., 124., 127., 128., 127., 128.,
...
TYPED_TEST(MaxWindow5Stride2, VALID3x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, SAME3x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      109., 110., 111., 112., 117., 118., 119., 120., 125., 126., 127., 128.,
      125., 126., 127., 128., 173., 174., 175., 176., 181., 182., 183., 184.,
...
TYPED_TEST(MaxWindow5Stride2, VALID3x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      145., 146., 147., 148., 153., 154., 155., 156., 209., 210., 211., 212.,
      217., 218., 219., 220., 273., 274., 275., 276., 281., 282., 283., 284.,
...
TYPED_TEST(MaxWindow5Stride2, SAME3x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, SAME3x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  71.,  72.,  75.,  76.,  79.,  80.,  79.,  80.,  107., 108.,
      111., 112., 115., 116., 119., 120., 119., 120., 147., 148., 151., 152.,
...
TYPED_TEST(MaxWindow5Stride2, VALID3x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, SAME3x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow5Stride2, VALID3x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
