...
using AvgWindow5Stride2 = PoolingFixture<DataType>;
TYPED_TEST_CASE(AvgWindow5Stride2, types::GTestKernelDataTypes);
TYPED_TEST(AvgWindow5Stride2, SAME1x7x7x1) {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x7x7x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x7x7x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, VALID1x7x7x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x7x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x7x7x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x7x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      10.5, 12., 14., 15., 18.5, 20., 22., 23.,
      34.5, 36., 38., 39., 42.5, 44., 46., 47.,
  };
...
TYPED_TEST(AvgWindow5Stride2, VALID1x7x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x7x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x7x8x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x7x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x7x8x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x7x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x7x10x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x7x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x7x10x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x7x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x7x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, SAME1x8x7x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      12.5, 13.5, 15.5, 16.5, 23., 24., 26., 27.,
...
TYPED_TEST(AvgWindow5Stride2, VALID1x8x7x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {17., 19., 31., 33.};
  const std::array<int, 4> in_shape = {{1, 8, 7, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x8x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x8x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {33., 34., 37., 38.,
                                         61., 62., 65., 66.};
  const std::array<int, 4> in_shape = {{1, 8, 7, 2}};
...
TYPED_TEST(AvgWindow5Stride2, SAME1x8x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x8x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {65.,  66.,  67.,  68.,  73.,  74.,
                                         75.,  76.,  121., 122., 123., 124.,
                                         129., 130., 131., 132.};
...
TYPED_TEST(AvgWindow5Stride2, SAME1x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      14.5, 16., 18., 19., 26.5, 28., 30., 31.,
      42.5, 44., 46., 47., 50.5, 52., 54., 55.,
  };
...
TYPED_TEST(AvgWindow5Stride2, VALID1x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {19., 21., 35., 37.};
  const std::array<int, 4> in_shape = {{1, 8, 8, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {37., 38., 41., 42.,
                                         69., 70., 73., 74.};
  const std::array<int, 4> in_shape = {{1, 8, 8, 2}};
...
TYPED_TEST(AvgWindow5Stride2, SAME1x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {73.,  74.,  75.,  76.,  81.,  82.,
                                         83.,  84.,  137., 138., 139., 140.,
                                         145., 146., 147., 148.};
...
TYPED_TEST(AvgWindow5Stride2, SAME1x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {23., 25., 27., 43., 45., 47.};
  const std::array<int, 4> in_shape = {{1, 8, 10, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {45., 46., 49., 50., 53., 54.,
                                         85., 86., 89., 90., 93., 94.};
  const std::array<int, 4> in_shape = {{1, 8, 10, 2}};
...
TYPED_TEST(AvgWindow5Stride2, SAME1x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      89.,  90.,  91.,  92.,  97.,  98.,  99.,  100., 105., 106., 107., 108.,
      169., 170., 171., 172., 177., 178., 179., 180., 185., 186., 187., 188.};
...
TYPED_TEST(AvgWindow5Stride2, SAME1x10x7x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x10x7x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x10x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x10x7x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x10x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x10x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, SAME1x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x10x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x10x8x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, SAME1x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID1x10x10x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME1x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      34.,  35.,  37.,  38.,  41.,  42.,  45.,  46.,  47.,  48.,
      64.,  65.,  67.,  68.,  71.,  72.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(AvgWindow5Stride2, VALID1x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {45.,  46.,  49.,  50.,  53.,  54.,
                                         85.,  86.,  89.,  90.,  93.,  94.,
...
TYPED_TEST(AvgWindow5Stride2, SAME1x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,
      89.,  90.,  91.,  92.,  93.,  94.,  95.,  96.,  127., 128., 129., 130.,
...
TYPED_TEST(AvgWindow5Stride2, VALID1x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      89.,  90.,  91.,  92.,  97.,  98.,  99.,  100., 105., 106., 107., 108.,
      169., 170., 171., 172., 177., 178., 179., 180., 185., 186., 187., 188.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x7x7x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID3x7x7x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME3x7x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID3x7x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, SAME3x7x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID3x7x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      65.,  66.,  67.,  68.,  73.,  74.,  75.,  76.,  121., 122., 123., 124.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x7x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      10.5,  12.,  14.,  15.,  18.5,  20.,  22.,  23.,  34.5,  36.,  38.,  39.,
      42.5,  44.,  46.,  47.,  66.5,  68.,  70.,  71.,  74.5,  76.,  78.,  79.,
      90.5,  92.,  94.,  95.,  98.5,  100., 102., 103., 122.5, 124., 126., 127.,
      130.5, 132., 134., 135., 146.5, 148., 150., 151., 154.5, 156., 158., 159.,
  };
...
TYPED_TEST(AvgWindow5Stride2, VALID3x7x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME3x7x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID3x7x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, SAME3x7x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID3x7x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,  137., 138., 139., 140.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x7x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      12.5,  14.,  16.,  18.,  19.,  22.5,  24.,  26.,  28.,  29.,
      42.5,  44.,  46.,  48.,  49.,  52.5,  54.,  56.,  58.,  59.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x7x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {23.,  25.,  27.,  43.,  45.,  47.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x7x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID3x7x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, SAME3x7x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      47.,  48.,  49.,  50.,  53.,  54.,  55.,  56.,  61.,  62.,  63.,  64.,
      69.,  70.,  71.,  72.,  73.,  74.,  75.,  76.,  87.,  88.,  89.,  90.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x7x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      89.,  90.,  91.,  92.,  97.,  98.,  99.,  100., 105., 106., 107., 108.,
      169., 170., 171., 172., 177., 178., 179., 180., 185., 186., 187., 188.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x8x7x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      12.5, 13.5, 15.5,  16.5,  23.,   24.,   26.,  27.,  37.,  38.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x8x7x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME3x8x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID3x8x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, SAME3x8x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      47.,  48.,  49.,  50.,  51.,  52.,  53.,  54.,  59.,  60.,  61.,  62.,
      63.,  64.,  65.,  66.,  89.,  90.,  91.,  92.,  93.,  94.,  95.,  96.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x8x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      65.,  66.,  67.,  68.,  73.,  74.,  75.,  76.,  121., 122., 123., 124.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      14.5,  16.,  18.,  19.,  26.5,  28.,  30.,  31.,  42.5,  44.,  46.,  47.,
      50.5,  52.,  54.,  55.,  78.5,  80.,  82.,  83.,  90.5,  92.,  94.,  95.,
      106.5, 108., 110., 111., 114.5, 116., 118., 119., 142.5, 144., 146., 147.,
      154.5, 156., 158., 159., 170.5, 172., 174., 175., 178.5, 180., 182., 183.,
  };
...
TYPED_TEST(AvgWindow5Stride2, VALID3x8x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow5Stride2, SAME3x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID3x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, SAME3x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  61.,  62.,  63.,  64.,  69.,  70.,  71.,  72.,
      73.,  74.,  75.,  76.,  103., 104., 105., 106., 109., 110., 111., 112.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,  137., 138., 139., 140.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      17.5,  19.,  21.,  23.,  24.,  32.5,  34.,  36.,  38.,  39.,
      52.5,  54.,  56.,  58.,  59.,  62.5,  64.,  66.,  68.,  69.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {23.,  25.,  27.,  43.,  45.,  47.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID3x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      45.,  46.,  49.,  50.,  53.,  54.,  85.,  86.,  89.,  90.,  93.,  94.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,
      89.,  90.,  91.,  92.,  93.,  94.,  95.,  96.,  127., 128., 129., 130.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      89.,  90.,  91.,  92.,  97.,  98.,  99.,  100., 105., 106., 107., 108.,
      169., 170., 171., 172., 177., 178., 179., 180., 185., 186., 187., 188.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x10x7x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      12.5,  13.5,  15.5,  16.5,  23.,  24.,  26.,  27.,  37.,  38.,
      40.,   41.,   51.,   52.,   54.,  55.,  58.,  59.,  61.,  62.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x10x7x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {17.,  19.,  31.,  33.,  45.,  47.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x10x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      24.,  25.,  26.,  27.,  30.,  31.,  32.,  33.,  45.,  46.,  47.,  48.,
      51.,  52.,  53.,  54.,  73.,  74.,  75.,  76.,  79.,  80.,  81.,  82.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x10x7x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, SAME3x10x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      47.,  48.,  49.,  50.,  51.,  52.,  53.,  54.,  59.,  60.,  61.,  62.,
      63.,  64.,  65.,  66.,  89.,  90.,  91.,  92.,  93.,  94.,  95.,  96.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x10x7x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      65.,  66.,  67.,  68.,  73.,  74.,  75.,  76.,  121., 122., 123., 124.,
      129., 130., 131., 132., 177., 178., 179., 180., 185., 186., 187., 188.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      14.5,  16.,  18.,  19.,  26.5,  28.,  30.,  31.,  42.5,  44.,  46.,  47.,
      58.5,  60.,  62.,  63.,  66.5,  68.,  70.,  71.,  94.5,  96.,  98.,  99.,
      106.5, 108., 110., 111., 122.5, 124., 126., 127., 138.5, 140., 142., 143.,
      146.5, 148., 150., 151., 174.5, 176., 178., 179., 186.5, 188., 190., 191.,
      202.5, 204., 206., 207., 218.5, 220., 222., 223., 226.5, 228., 230., 231.,
  };
...
TYPED_TEST(AvgWindow5Stride2, VALID3x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {19.,  21.,  35.,  37.,  51.,  53.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      28.,  29.,  31.,  32.,  35.,  36.,  37.,  38.,  52.,  53.,  55.,  56.,
      59.,  60.,  61.,  62.,  84.,  85.,  87.,  88.,  91.,  92.,  93.,  94.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, SAME3x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  61.,  62.,  63.,  64.,  69.,  70.,  71.,  72.,
      73.,  74.,  75.,  76.,  103., 104., 105., 106., 109., 110., 111., 112.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,  137., 138., 139., 140.,
      145., 146., 147., 148., 201., 202., 203., 204., 209., 210., 211., 212.,
...
TYPED_TEST(AvgWindow5Stride2, SAME3x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      17.5,  19.,  21.,  23.,  24.,  32.5,  34.,  36.,  38.,  39.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, SAME3x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      34.,  35.,  37.,  38.,  41.,  42.,  45.,  46.,  47.,  48.,  64.,  65.,
      67.,  68.,  71.,  72.,  75.,  76.,  77.,  78.,  104., 105., 107., 108.,
...
TYPED_TEST(AvgWindow5Stride2, VALID3x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, SAME3x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow5Stride2, VALID3x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
