...
TYPED_TEST(AvgWindow7Stride1Forward, SAME3x8x8x4) {
  ...
  const std::vector<DataType> exp_out = {
      ...
      453., 454., 455., 456., 455., 456., 457., 458., 55.,  56.,  57.,  58.,
      57.,  58.,  59.,  60.,  59.,  60.,  61.,  62.,  61.,  62.,  63.,  64.,
      65.,  66.,  67.,  68.,  67.,  68.,  69.,  70.,  69.,  70.,  71.,  72.,
      71.,  72.,  73.,  74.,  71.,  72.,  73.,  74.,  73.,  74.,  75.,  76.,
      75.,  76.,  77.,  78.,  77.,  78.,  79.,  80.,  81.,  82.,  83.,  84.,
      83.,  84.,  85.,  86.,  85.,  86.,  87.,  88.,  87.,  88.,  89.,  90.,
      87.,  88.,  89.,  90.,  89.,  90.,  91.,  92.,  91.,  92.,  93.,  94.,
      93.,  94.,  95.,  96.,  97.,  98.,  99.,  100., 99.,  100., 101., 102.,
      101., 102., 103., 104., 103., 104., 105., 106., 103., 104., 105., 106.,
      105., 106., 107., 108., 107., 108., 109., 110., 109., 110., 111., 112.,
      113., 114., 115., 116., 115., 116., 117., 118., 117., 118., 119., 120.,
      119., 120., 121., 122., 135., 136., 137., 138., 137., 138., 139., 140.,
      ...
      165., 166., 167., 168., 167., 168., 169., 170., 167., 168., 169., 170.,
      169., 170., 171., 172., 171., 172., 173., 174., 173., 174., 175., 176.,
      177., 178., 179., 180., 179., 180., 181., 182., 181., 182., 183., 184.,
      183., 184., 185., 186., 183., 184., 185., 186., 185., 186., 187., 188.,
...
TYPED_TEST(AvgWindow7Stride1Forward, VALID3x8x8x4) {
  ...
  const std::vector<DataType> exp_out = {
      ...
      397., 398., 399., 400., 401., 402., 403., 404., 109., 110., 111., 112.,
      113., 114., 115., 116., 141., 142., 143., 144., 145., 146., 147., 148.};
  const std::array<int, 4> in_shape = {{3, 8, 8, 4}};
  const auto padding = PaddingMode::VALID;
  const auto params = getPoolingParams<7, 1>(in_shape, padding);
  const DataType max_input_val = 512.0;
...
TYPED_TEST(AvgWindow7Stride1Forward, SAME3x9x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {55.,
                                         56.,
                                         57.,
                                         58.,
                                         57.,
...
TYPED_TEST(AvgWindow7Stride1Forward, VALID3x9x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {109.,
                                         110.,
                                         111.,
                                         112.,
                                         113.,
...
TYPED_TEST(AvgWindow7Stride1Forward, SAME3x9x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {34.,
                                         35.,
                                         35.,
                                         36.,
                                         36.,
