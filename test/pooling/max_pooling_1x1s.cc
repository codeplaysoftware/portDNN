 ...
 * Input: 1    Output: 1
 */
TYPED_TEST(OneByOneInputMaxPoolingTest, Basic1x1Plain) {
 ...
 *           4               4
 */
TYPED_TEST(OneByOneInputMaxPoolingTest, Deep1x1Plain) {
  using DataType = typename TestFixture::DataType;
 ...
 *           4  8             4  8
 */
TYPED_TEST(OneByOneInputMaxPoolingTest, BatchedDeep1x1Plain) {
  using DataType = typename TestFixture::DataType;
 ...
 *
 */
TYPED_TEST(OneByOneInputMaxPoolingTest, BatchedDeep1x1Plain2x2Window) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {1., 2., 3., 4., 5., 6., 7., 8.};
  const std::array<int, 4> in_shape = {{2, 1, 1, 4}};
