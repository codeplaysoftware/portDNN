...
using AvgWindow7Stride1 = PoolingFixture<DataType>;
TYPED_TEST_CASE(AvgWindow7Stride1, types::GTestKernelDataTypes);
TYPED_TEST(AvgWindow7Stride1, SAME1x8x8x1) {
...
TYPED_TEST(AvgWindow7Stride1, VALID1x8x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow7Stride1, SAME1x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID1x8x8x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow7Stride1, SAME1x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID1x8x8x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow7Stride1, SAME1x8x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID1x8x9x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow7Stride1, SAME1x8x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID1x8x9x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow7Stride1, SAME1x8x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID1x8x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 123., 124., 125., 126., 127., 128., 129., 130., 131., 132.,
      157., 158., 159., 160., 161., 162., 163., 164., 165., 166., 167., 168.};
...
TYPED_TEST(AvgWindow7Stride1, SAME1x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID1x8x10x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow7Stride1, SAME1x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID1x8x10x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow7Stride1, SAME1x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID1x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME1x9x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID1x9x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow7Stride1, SAME1x9x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID1x9x8x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow7Stride1, SAME1x9x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  57.,  58.,  59.,  60.,  59.,  60.,  61.,  62.,
      61.,  62.,  63.,  64.,  65.,  66.,  67.,  68.,  67.,  68.,  69.,  70.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x9x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME1x9x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      16.,  16.5, 17.,  17.5, 18.5, 19.5, 20.,  20.5, 21.,  20.5, 21.,  21.5,
      22.,  23.,  24.,  24.5, 25.,  25.5, 25.,  25.5, 26.,  26.5, 27.5, 28.5,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x9x9x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow7Stride1, SAME1x9x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      31.,  32.,  32.,  33.,  33.,  34.,  34.,  35.,  36.,  37.,  38.,  39.,
      39.,  40.,  40.,  41.,  41.,  42.,  40.,  41.,  41.,  42.,  42.,  43.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x9x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {61., 62., 63., 64.,  65.,  66.,
                                         79., 80., 81., 82.,  83.,  84.,
...
TYPED_TEST(AvgWindow7Stride1, SAME1x9x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      61.,  62.,  63.,  64.,  63.,  64.,  65.,  66.,  65.,  66.,  67.,  68.,
      67.,  68.,  69.,  70.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x9x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 123., 124., 125., 126., 127., 128., 129., 130., 131., 132.,
      157., 158., 159., 160., 161., 162., 163., 164., 165., 166., 167., 168.,
...
TYPED_TEST(AvgWindow7Stride1, SAME1x9x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      17.5, 18.,  18.5, 19.,  20.,  21.,  22.,  22.5, 23.,  23.5, 22.5, 23.,
      23.5, 24.,  25.,  26.,  27.,  27.5, 28.,  28.5, 27.5, 28.,  28.5, 29.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x9x10x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow7Stride1, SAME1x9x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      34.,  35.,  35.,  36.,  36.,  37.,  37.,  38.,  39.,  40.,  41.,  42.,
      43.,  44.,  44.,  45.,  45.,  46.,  46.,  47.,  44.,  45.,  45.,  46.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x9x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME1x9x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  69.,  70.,  71.,  72.,  71.,  72.,  73.,  74.,
      73.,  74.,  75.,  76.,  77.,  78.,  79.,  80.,  81.,  82.,  83.,  84.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x9x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 137., 138., 139., 140., 141., 142., 143., 144.,
      145., 146., 147., 148., 173., 174., 175., 176., 177., 178., 179., 180.,
...
TYPED_TEST(AvgWindow7Stride1, SAME1x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      14.5, 15.,  15.5, 16.,  17.,  17.5, 18.,  18.5, 18.5, 19.,  19.5, 20.,
      21.,  21.5, 22.,  22.5, 22.5, 23.,  23.5, 24.,  25.,  25.5, 26.,  26.5,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {28., 29., 36., 37.,
                                         44., 45., 52., 53.};
  const std::array<int, 4> in_shape = {{1, 10, 8, 1}};
...
TYPED_TEST(AvgWindow7Stride1, SAME1x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      28.,  29.,  29.,  30.,  30.,  31.,  31.,  32.,  33.,  34.,  34.,  35.,
      35.,  36.,  36.,  37.,  36.,  37.,  37.,  38.,  38.,  39.,  39.,  40.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {55.,  56.,  57.,  58., 71., 72.,
                                         73.,  74.,  87.,  88., 89., 90.,
                                         103., 104., 105., 106.};
...
TYPED_TEST(AvgWindow7Stride1, SAME1x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  57.,  58.,  59.,  60.,  59.,  60.,  61.,  62.,
      61.,  62.,  63.,  64.,  65.,  66.,  67.,  68.,  67.,  68.,  69.,  70.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME1x10x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      16.,  16.5, 17.,  17.5, 18.5, 19.5, 20.,  20.5, 21.,  20.5, 21.,  21.5,
      22.,  23.,  24.,  24.5, 25.,  25.5, 25.,  25.5, 26.,  26.5, 27.5, 28.5,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x10x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {31., 32., 33., 40., 41., 42.,
                                         49., 50., 51., 58., 59., 60.};
  const std::array<int, 4> in_shape = {{1, 10, 9, 1}};
...
TYPED_TEST(AvgWindow7Stride1, SAME1x10x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      31.,  32.,  32.,  33.,  33.,  34.,  34.,  35.,  36.,  37.,  38.,  39.,
      39.,  40.,  40.,  41.,  41.,  42.,  40.,  41.,  41.,  42.,  42.,  43.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x10x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME1x10x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      61.,  62.,  63.,  64.,  63.,  64.,  65.,  66.,  65.,  66.,  67.,  68.,
      67.,  68.,  69.,  70.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x10x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 123., 124., 125., 126., 127., 128., 129., 130., 131., 132.,
      157., 158., 159., 160., 161., 162., 163., 164., 165., 166., 167., 168.,
...
TYPED_TEST(AvgWindow7Stride1, SAME1x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      17.5, 18.,  18.5, 19.,  20.,  21.,  22.,  22.5, 23.,  23.5, 22.5, 23.,
      23.5, 24.,  25.,  26.,  27.,  27.5, 28.,  28.5, 27.5, 28.,  28.5, 29.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {34., 35., 36., 37., 44., 45.,
                                         46., 47., 54., 55., 56., 57.,
                                         64., 65., 66., 67.};
...
TYPED_TEST(AvgWindow7Stride1, SAME1x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      34.,  35.,  35.,  36.,  36.,  37.,  37.,  38.,  39.,  40.,  41.,  42.,
      43.,  44.,  44.,  45.,  45.,  46.,  46.,  47.,  44.,  45.,  45.,  46.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME1x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  69.,  70.,  71.,  72.,  71.,  72.,  73.,  74.,
      73.,  74.,  75.,  76.,  77.,  78.,  79.,  80.,  81.,  82.,  83.,  84.,
...
TYPED_TEST(AvgWindow7Stride1, VALID1x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 137., 138., 139., 140., 141., 142., 143.,
      144., 145., 146., 147., 148., 173., 174., 175., 176., 177., 178.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID3x8x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow7Stride1, SAME3x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      28.,  29.,  29.,  30.,  30.,  31.,  31.,  32.,  33.,  34.,  34.,  35.,
      35.,  36.,  36.,  37.,  36.,  37.,  37.,  38.,  38.,  39.,  39.,  40.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME3x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  57.,  58.,  59.,  60.,  59.,  60.,  61.,  62.,
      61.,  62.,  63.,  64.,  65.,  66.,  67.,  68.,  67.,  68.,  69.,  70.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      109., 110., 111., 112., 113., 114., 115., 116., 141., 142., 143., 144.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x8x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID3x8x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {31.,  32.,  33.,  40.,  41.,  42.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x8x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      31.,  32.,  32.,  33.,  33.,  34.,  34.,  35.,  36.,  37.,  38.,  39.,
      39.,  40.,  40.,  41.,  41.,  42.,  40.,  41.,  41.,  42.,  42.,  43.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x8x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      61.,  62.,  63.,  64.,  65.,  66.,  79.,  80.,  81.,  82.,  83.,  84.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x8x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      61.,  62.,  63.,  64.,  63.,  64.,  65.,  66.,  65.,  66.,  67.,  68.,
      67.,  68.,  69.,  70.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x8x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 123., 124., 125., 126., 127., 128., 129., 130., 131., 132.,
      157., 158., 159., 160., 161., 162., 163., 164., 165., 166., 167., 168.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID3x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME3x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      34.,  35.,  35.,  36.,  36.,  37.,  37.,  38.,  39.,  40.,  41.,  42.,
      43.,  44.,  44.,  45.,  45.,  46.,  46.,  47.,  44.,  45.,  45.,  46.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  71.,  72.,  73.,  74.,  87.,  88.,  89.,  90.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  69.,  70.,  71.,  72.,  71.,  72.,  73.,  74.,
      73.,  74.,  75.,  76.,  77.,  78.,  79.,  80.,  81.,  82.,  83.,  84.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 137., 138., 139., 140., 141., 142., 143., 144.,
      145., 146., 147., 148., 173., 174., 175., 176., 177., 178., 179., 180.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x9x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      14.5,  15.,   15.5,  16.,   17.,   17.5,  18.,   18.5,  18.5,  19.,
      19.5,  20.,   21.,   21.5,  22.,   22.5,  22.5,  23.,   23.5,  24.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x9x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {28.,  29.,  36.,  37.,  44.,  45.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x9x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      28.,  29.,  29.,  30.,  30.,  31.,  31.,  32.,  33.,  34.,  34.,  35.,
      35.,  36.,  36.,  37.,  36.,  37.,  37.,  38.,  38.,  39.,  39.,  40.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x9x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME3x9x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  57.,  58.,  59.,  60.,  59.,  60.,  61.,  62.,
      61.,  62.,  63.,  64.,  65.,  66.,  67.,  68.,  67.,  68.,  69.,  70.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x9x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      109., 110., 111., 112., 113., 114., 115., 116., 141., 142., 143., 144.,
      145., 146., 147., 148., 173., 174., 175., 176., 177., 178., 179., 180.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x9x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      16.,   16.5,  17.,   17.5,  18.5,  19.5,  20.,   20.5,  21.,   20.5,
      21.,   21.5,  22.,   23.,   24.,   24.5,  25.,   25.5,  25.,   25.5,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x9x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME3x9x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      31.,  32.,  32.,  33.,  33.,  34.,  34.,  35.,  36.,  37.,  38.,  39.,
      39.,  40.,  40.,  41.,  41.,  42.,  40.,  41.,  41.,  42.,  42.,  43.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x9x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME3x9x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      61.,  62.,  63.,  64.,  63.,  64.,  65.,  66.,  65.,  66.,  67.,  68.,
      67.,  68.,  69.,  70.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x9x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 123., 124., 125., 126., 127., 128., 129., 130., 131., 132.,
      157., 158., 159., 160., 161., 162., 163., 164., 165., 166., 167., 168.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x9x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      17.5,  18.,  18.5,  19.,  20.,  21.,  22.,  22.5,  23.,  23.5,
      22.5,  23.,  23.5,  24.,  25.,  26.,  27.,  27.5,  28.,  28.5,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x9x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME3x9x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      34.,  35.,  35.,  36.,  36.,  37.,  37.,  38.,  39.,  40.,  41.,  42.,
      43.,  44.,  44.,  45.,  45.,  46.,  46.,  47.,  44.,  45.,  45.,  46.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x9x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  71.,  72.,  73.,  74.,  87.,  88.,  89.,  90.,
      91.,  92.,  93.,  94.,  107., 108., 109., 110., 111., 112., 113., 114.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x9x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID3x9x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 137., 138., 139., 140., 141., 142., 143., 144.,
      145., 146., 147., 148., 173., 174., 175., 176., 177., 178., 179., 180.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      14.5,  15.,   15.5,  16.,   17.,   17.5,  18.,   18.5,  18.5,  19.,
      19.5,  20.,   21.,   21.5,  22.,   22.5,  22.5,  23.,   23.5,  24.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME3x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      28.,  29.,  29.,  30.,  30.,  31.,  31.,  32.,  33.,  34.,  34.,  35.,
      35.,  36.,  36.,  37.,  36.,  37.,  37.,  38.,  38.,  39.,  39.,  40.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  71.,  72.,  73.,  74.,  87.,  88.,  89.,  90.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  57.,  58.,  59.,  60.,  59.,  60.,  61.,  62.,
      61.,  62.,  63.,  64.,  65.,  66.,  67.,  68.,  67.,  68.,  69.,  70.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      109., 110., 111., 112., 113., 114., 115., 116., 141., 142., 143., 144.,
      145., 146., 147., 148., 173., 174., 175., 176., 177., 178., 179., 180.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x10x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      16.,   16.5,  17.,   17.5,  18.5,  19.5,  20.,   20.5,  21.,   20.5,
      21.,   21.5,  22.,   23.,   24.,   24.5,  25.,   25.5,  25.,   25.5,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x10x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, SAME3x10x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      31.,  32.,  32.,  33.,  33.,  34.,  34.,  35.,  36.,  37.,  38.,  39.,
      39.,  40.,  40.,  41.,  41.,  42.,  40.,  41.,  41.,  42.,  42.,  43.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x10x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      61.,  62.,  63.,  64.,  65.,  66.,  79.,  80.,  81.,  82.,  83.,  84.,
      97.,  98.,  99.,  100., 101., 102., 115., 116., 117., 118., 119., 120.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x10x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow7Stride1, VALID3x10x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 123., 124., 125., 126., 127., 128., 129., 130., 131., 132.,
      157., 158., 159., 160., 161., 162., 163., 164., 165., 166., 167., 168.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      17.5,  18.,  18.5,  19.,  20.,  21.,  22.,  22.5,  23.,  23.5,
      22.5,  23.,  23.5,  24.,  25.,  26.,  27.,  27.5,  28.,  28.5,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      34.,  35.,  36.,  37.,  44.,  45.,  46.,  47.,  54.,  55.,  56.,  57.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      34.,  35.,  35.,  36.,  36.,  37.,  37.,  38.,  39.,  40.,  41.,  42.,
      43.,  44.,  44.,  45.,  45.,  46.,  46.,  47.,  44.,  45.,  45.,  46.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  71.,  72.,  73.,  74.,  87.,  88.,  89.,  90.,
      91.,  92.,  93.,  94.,  107., 108., 109., 110., 111., 112., 113., 114.,
...
TYPED_TEST(AvgWindow7Stride1, SAME3x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,   68.,   69.,   70.,   69.,   70.,   71.,   72.,   71.,   72.,
      73.,   74.,   73.,   74.,   75.,   76.,   77.,   78.,   79.,   80.,
...
TYPED_TEST(AvgWindow7Stride1, VALID3x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
