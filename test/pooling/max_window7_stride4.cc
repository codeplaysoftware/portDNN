...
using MaxWindow7Stride4 = PoolingFixture<DataType>;
TYPED_TEST_CASE(MaxWindow7Stride4, types::GTestKernelDataTypes);
TYPED_TEST(MaxWindow7Stride4, SAME1x11x11x1) {
...
TYPED_TEST(MaxWindow7Stride4, VALID1x11x11x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x11x11x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, VALID1x11x11x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x11x11x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, VALID1x11x11x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x11x12x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, VALID1x11x12x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x11x12x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, VALID1x11x12x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x11x12x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID1x11x12x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x11x14x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, VALID1x11x14x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x11x14x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID1x11x14x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x11x14x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID1x11x14x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x12x11x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, VALID1x12x11x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {73., 77., 117., 121.};
  const std::array<int, 4> in_shape = {{1, 12, 11, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x12x11x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, VALID1x12x11x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {145., 146., 153., 154.,
                                         233., 234., 241., 242.};
  const std::array<int, 4> in_shape = {{1, 12, 11, 2}};
...
TYPED_TEST(MaxWindow7Stride4, SAME1x12x11x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID1x12x11x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {289., 290., 291., 292., 305., 306.,
                                         307., 308., 465., 466., 467., 468.,
                                         481., 482., 483., 484.};
...
TYPED_TEST(MaxWindow7Stride4, SAME1x12x12x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, VALID1x12x12x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {79., 83., 127., 131.};
  const std::array<int, 4> in_shape = {{1, 12, 12, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x12x12x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, VALID1x12x12x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {157., 158., 165., 166.,
                                         253., 254., 261., 262.};
  const std::array<int, 4> in_shape = {{1, 12, 12, 2}};
...
TYPED_TEST(MaxWindow7Stride4, SAME1x12x12x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID1x12x12x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {313., 314., 315., 316., 329., 330.,
                                         331., 332., 505., 506., 507., 508.,
                                         521., 522., 523., 524.};
...
TYPED_TEST(MaxWindow7Stride4, SAME1x12x14x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, VALID1x12x14x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {91., 95., 147., 151.};
  const std::array<int, 4> in_shape = {{1, 12, 14, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x12x14x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID1x12x14x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {181., 182., 189., 190.,
                                         293., 294., 301., 302.};
  const std::array<int, 4> in_shape = {{1, 12, 14, 2}};
...
TYPED_TEST(MaxWindow7Stride4, SAME1x12x14x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID1x12x14x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {361., 362., 363., 364., 377., 378.,
                                         379., 380., 585., 586., 587., 588.,
                                         601., 602., 603., 604.};
...
TYPED_TEST(MaxWindow7Stride4, SAME1x14x11x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, VALID1x14x11x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {73., 77., 117., 121.};
  const std::array<int, 4> in_shape = {{1, 14, 11, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x14x11x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID1x14x11x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {145., 146., 153., 154.,
                                         233., 234., 241., 242.};
  const std::array<int, 4> in_shape = {{1, 14, 11, 2}};
...
TYPED_TEST(MaxWindow7Stride4, SAME1x14x11x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      193., 194., 195., 196., 209., 210., 211., 212., 217., 218., 219., 220.,
      369., 370., 371., 372., 385., 386., 387., 388., 393., 394., 395., 396.,
...
TYPED_TEST(MaxWindow7Stride4, VALID1x14x11x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {289., 290., 291., 292., 305., 306.,
                                         307., 308., 465., 466., 467., 468.,
                                         481., 482., 483., 484.};
...
TYPED_TEST(MaxWindow7Stride4, SAME1x14x12x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, VALID1x14x12x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {79., 83., 127., 131.};
  const std::array<int, 4> in_shape = {{1, 14, 12, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x14x12x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID1x14x12x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {157., 158., 165., 166.,
                                         253., 254., 261., 262.};
  const std::array<int, 4> in_shape = {{1, 14, 12, 2}};
...
TYPED_TEST(MaxWindow7Stride4, SAME1x14x12x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      213., 214., 215., 216., 229., 230., 231., 232., 237., 238., 239., 240.,
      405., 406., 407., 408., 421., 422., 423., 424., 429., 430., 431., 432.,
...
TYPED_TEST(MaxWindow7Stride4, VALID1x14x12x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {313., 314., 315., 316., 329., 330.,
                                         331., 332., 505., 506., 507., 508.,
                                         521., 522., 523., 524.};
...
TYPED_TEST(MaxWindow7Stride4, SAME1x14x14x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {61.,  65.,  69.,  70.,  117., 121.,
...
TYPED_TEST(MaxWindow7Stride4, VALID1x14x14x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {91., 95., 147., 151.};
  const std::array<int, 4> in_shape = {{1, 14, 14, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow7Stride4, SAME1x14x14x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID1x14x14x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {181., 182., 189., 190.,
                                         293., 294., 301., 302.};
  const std::array<int, 4> in_shape = {{1, 14, 14, 2}};
...
TYPED_TEST(MaxWindow7Stride4, SAME1x14x14x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID1x14x14x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {361., 362., 363., 364., 377., 378.,
                                         379., 380., 585., 586., 587., 588.,
                                         601., 602., 603., 604.};
...
TYPED_TEST(MaxWindow7Stride4, SAME3x11x11x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x11x11x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME3x11x11x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x11x11x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, SAME3x11x11x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x11x11x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, SAME3x11x12x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x11x12x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME3x11x12x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x11x12x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, SAME3x11x12x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x11x12x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, SAME3x11x14x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x11x14x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME3x11x14x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 129., 130., 137., 138., 139., 140., 233., 234., 241., 242.,
      249., 250., 251., 252., 289., 290., 297., 298., 305., 306., 307., 308.,
...
TYPED_TEST(MaxWindow7Stride4, VALID3x11x14x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, SAME3x11x14x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x11x14x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, SAME3x12x11x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x12x11x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME3x12x11x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x12x11x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, SAME3x12x11x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x12x11x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      289.,  290.,  291.,  292.,  305.,  306.,  307.,  308.,  465.,  466.,
...
TYPED_TEST(MaxWindow7Stride4, SAME3x12x12x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x12x12x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME3x12x12x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x12x12x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, SAME3x12x12x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x12x12x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      313.,  314.,  315.,  316.,  329.,  330.,  331.,  332.,  505.,  506.,
...
TYPED_TEST(MaxWindow7Stride4, SAME3x12x14x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x12x14x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME3x12x14x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x12x14x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, SAME3x12x14x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x12x14x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      361.,  362.,  363.,  364.,  377.,  378.,  379.,  380.,  585.,  586.,
...
TYPED_TEST(MaxWindow7Stride4, SAME3x14x11x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x14x11x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME3x14x11x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      97.,  98.,  105., 106., 109., 110., 185., 186., 193., 194., 197., 198.,
      273., 274., 281., 282., 285., 286., 295., 296., 303., 304., 307., 308.,
...
TYPED_TEST(MaxWindow7Stride4, VALID3x14x11x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, SAME3x14x11x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      193.,  194.,  195.,  196.,  209.,  210.,  211.,  212.,  217.,  218.,
      219.,  220.,  369.,  370.,  371.,  372.,  385.,  386.,  387.,  388.,
...
TYPED_TEST(MaxWindow7Stride4, VALID3x14x11x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      289.,  290.,  291.,  292.,  305.,  306.,  307.,  308.,  465.,  466.,
...
TYPED_TEST(MaxWindow7Stride4, SAME3x14x12x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x14x12x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME3x14x12x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      107., 108., 115.,  116.,  119.,  120., 203., 204., 211., 212., 215.,
...
TYPED_TEST(MaxWindow7Stride4, VALID3x14x12x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, SAME3x14x12x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      213.,  214.,  215.,  216.,  229.,  230.,  231.,  232.,  237.,  238.,
      239.,  240.,  405.,  406.,  407.,  408.,  421.,  422.,  423.,  424.,
...
TYPED_TEST(MaxWindow7Stride4, VALID3x14x12x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      313.,  314.,  315.,  316.,  329.,  330.,  331.,  332.,  505.,  506.,
...
TYPED_TEST(MaxWindow7Stride4, SAME3x14x14x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x14x14x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride4, SAME3x14x14x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, VALID3x14x14x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride4, SAME3x14x14x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      241.,  242.,  243.,  244.,  257.,  258.,  259.,  260.,  273.,  274.,
      275.,  276.,  277.,  278.,  279.,  280.,  465.,  466.,  467.,  468.,
...
TYPED_TEST(MaxWindow7Stride4, VALID3x14x14x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      361.,  362.,  363.,  364.,  377.,  378.,  379.,  380.,  585.,  586.,
