...
using MaxWindow3Stride2 = PoolingFixture<DataType>;
TYPED_TEST_CASE(MaxWindow3Stride2, types::GTestKernelDataTypes);
TYPED_TEST(MaxWindow3Stride2, SAME1x5x5x1) {
...
TYPED_TEST(MaxWindow3Stride2, VALID1x5x5x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x5x5x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, VALID1x5x5x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x5x5x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, VALID1x5x5x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x5x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, VALID1x5x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x5x6x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, VALID1x5x6x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x5x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID1x5x6x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x5x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, VALID1x5x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x5x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID1x5x8x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x5x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID1x5x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, SAME1x6x5x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, VALID1x6x5x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {13., 15., 23., 25.};
  const std::array<int, 4> in_shape = {{1, 6, 5, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x6x5x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, VALID1x6x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {25., 26., 29., 30.,
                                         45., 46., 49., 50.};
  const std::array<int, 4> in_shape = {{1, 6, 5, 2}};
...
TYPED_TEST(MaxWindow3Stride2, SAME1x6x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID1x6x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {49., 50., 51., 52., 57., 58.,
                                         59., 60., 89., 90., 91., 92.,
                                         97., 98., 99., 100.};
...
TYPED_TEST(MaxWindow3Stride2, SAME1x6x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, VALID1x6x6x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {15., 17., 27., 29.};
  const std::array<int, 4> in_shape = {{1, 6, 6, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x6x6x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, VALID1x6x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {29., 30., 33., 34.,
                                         53., 54., 57., 58.};
  const std::array<int, 4> in_shape = {{1, 6, 6, 2}};
...
TYPED_TEST(MaxWindow3Stride2, SAME1x6x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID1x6x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {57.,  58.,  59.,  60.,  65.,  66.,
                                         67.,  68.,  105., 106., 107., 108.,
                                         113., 114., 115., 116.};
...
TYPED_TEST(MaxWindow3Stride2, SAME1x6x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, VALID1x6x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {19., 21., 23., 35., 37., 39.};
  const std::array<int, 4> in_shape = {{1, 6, 8, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x6x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID1x6x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {37., 38., 41., 42., 45., 46.,
                                         69., 70., 73., 74., 77., 78.};
  const std::array<int, 4> in_shape = {{1, 6, 8, 2}};
...
TYPED_TEST(MaxWindow3Stride2, SAME1x6x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,  89.,  90.,  91.,  92.,
...
TYPED_TEST(MaxWindow3Stride2, VALID1x6x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,  89.,  90.,  91.,  92.,
      137., 138., 139., 140., 145., 146., 147., 148., 153., 154., 155., 156.};
...
TYPED_TEST(MaxWindow3Stride2, SAME1x8x5x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, VALID1x8x5x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x8x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID1x8x5x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x8x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      45.,  46.,  47.,  48.,  53.,  54.,  55.,  56.,  57.,  58.,  59.,  60.,
      85.,  86.,  87.,  88.,  93.,  94.,  95.,  96.,  97.,  98.,  99.,  100.,
...
TYPED_TEST(MaxWindow3Stride2, VALID1x8x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, SAME1x8x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, VALID1x8x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x8x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID1x8x6x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x8x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      57.,  58.,  59.,  60.,  65.,  66.,  67.,  68.,  69.,  70.,  71.,  72.,
      105., 106., 107., 108., 113., 114., 115., 116., 117., 118., 119., 120.,
...
TYPED_TEST(MaxWindow3Stride2, VALID1x8x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, SAME1x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {19., 21., 23., 24., 35., 37.,
                                         39., 40., 51., 53., 55., 56.,
                                         59., 61., 63., 64.};
...
TYPED_TEST(MaxWindow3Stride2, VALID1x8x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME1x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID1x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {37.,  38.,  41.,  42.,  45.,  46.,
                                         69.,  70.,  73.,  74.,  77.,  78.,
...
TYPED_TEST(MaxWindow3Stride2, SAME1x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID1x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,  89.,  90.,  91.,  92.,
      137., 138., 139., 140., 145., 146., 147., 148., 153., 154., 155., 156.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x5x5x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x5x5x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME3x5x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x5x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, SAME3x5x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      25.,  26.,  27.,  28.,  33.,  34.,  35.,  36.,  37.,  38.,  39.,  40.,
      65.,  66.,  67.,  68.,  73.,  74.,  75.,  76.,  77.,  78.,  79.,  80.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x5x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      49.,  50.,  51.,  52.,  57.,  58.,  59.,  60.,  89.,  90.,  91.,  92.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x5x6x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x5x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME3x5x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x5x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, SAME3x5x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      33.,  34.,  35.,  36.,  41.,  42.,  43.,  44.,  45.,  46.,  47.,  48.,
      81.,  82.,  83.,  84.,  89.,  90.,  91.,  92.,  93.,  94.,  95.,  96.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x5x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      57.,  58.,  59.,  60.,  65.,  66.,  67.,  68.,  105., 106., 107., 108.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x5x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x5x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {19., 21.,  23.,  35.,  37.,  39.,
                                         59., 61.,  63.,  75.,  77.,  79.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x5x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      21.,  22.,  25.,  26.,  29.,  30.,  31.,  32.,  53.,  54.,  57.,  58.,
      61.,  62.,  63.,  64.,  69.,  70.,  73.,  74.,  77.,  78.,  79.,  80.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x5x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, SAME3x5x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      41.,  42.,  43.,  44.,  49.,  50.,  51.,  52.,  57.,  58.,  59.,  60.,
      61.,  62.,  63.,  64.,  105., 106., 107., 108., 113., 114., 115., 116.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x5x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,  89.,  90.,  91.,  92.,
      137., 138., 139., 140., 145., 146., 147., 148., 153., 154., 155., 156.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x6x5x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x6x5x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME3x6x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x6x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, SAME3x6x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      45.,  46.,  47.,  48.,  53.,  54.,  55.,  56.,  57.,  58.,  59.,  60.,
      85.,  86.,  87.,  88.,  93.,  94.,  95.,  96.,  97.,  98.,  99.,  100.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x6x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      49.,  50.,  51.,  52.,  57.,  58.,  59.,  60.,  89.,  90.,  91.,  92.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x6x6x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x6x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow3Stride2, SAME3x6x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x6x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, SAME3x6x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      57.,  58.,  59.,  60.,  65.,  66.,  67.,  68.,  69.,  70.,  71.,  72.,
      105., 106., 107., 108., 113., 114., 115., 116., 117., 118., 119., 120.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x6x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      57.,  58.,  59.,  60.,  65.,  66.,  67.,  68.,  105., 106., 107., 108.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x6x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x6x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {19.,  21.,  23.,  35.,  37.,  39.,
                                         67.,  69.,  71.,  83.,  85.,  87.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x6x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      37.,  38.,  41.,  42.,  45.,  46.,  47.,  48.,  69.,  70.,  73.,  74.,
      77.,  78.,  79.,  80.,  85.,  86.,  89.,  90.,  93.,  94.,  95.,  96.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x6x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      37.,  38.,  41.,  42.,  45.,  46.,  69.,  70.,  73.,  74.,  77.,  78.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x6x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,  89.,  90.,  91.,  92.,
      93.,  94.,  95.,  96.,  137., 138., 139., 140., 145., 146., 147., 148.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x6x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,  89.,  90.,  91.,  92.,
      137., 138., 139., 140., 145., 146., 147., 148., 153., 154., 155., 156.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x8x5x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x8x5x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {13., 15., 23.,  25.,  33.,  35.,
                                         53., 55., 63.,  65.,  73.,  75.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x8x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      23.,  24.,  27.,  28.,  29.,  30.,  43.,  44.,  47.,  48.,  49.,  50.,
      63.,  64.,  67.,  68.,  69.,  70.,  73.,  74.,  77.,  78.,  79.,  80.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x8x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, SAME3x8x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      45.,  46.,  47.,  48.,  53.,  54.,  55.,  56.,  57.,  58.,  59.,  60.,
      85.,  86.,  87.,  88.,  93.,  94.,  95.,  96.,  97.,  98.,  99.,  100.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x8x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      49.,  50.,  51.,  52.,  57.,  58.,  59.,  60.,  89.,  90.,  91.,  92.,
      97.,  98.,  99.,  100., 129., 130., 131., 132., 137., 138., 139., 140.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x8x6x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x8x6x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {15.,  17.,  27.,  29.,  39.,  41.,
                                         63.,  65.,  75.,  77.,  87.,  89.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x8x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      29.,  30.,  33.,  34.,  35.,  36.,  53.,  54.,  57.,  58.,  59.,  60.,
      77.,  78.,  81.,  82.,  83.,  84.,  89.,  90.,  93.,  94.,  95.,  96.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x8x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, SAME3x8x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      57.,  58.,  59.,  60.,  65.,  66.,  67.,  68.,  69.,  70.,  71.,  72.,
      105., 106., 107., 108., 113., 114., 115., 116., 117., 118., 119., 120.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x8x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      57.,  58.,  59.,  60.,  65.,  66.,  67.,  68.,  105., 106., 107., 108.,
      113., 114., 115., 116., 153., 154., 155., 156., 161., 162., 163., 164.,
...
TYPED_TEST(MaxWindow3Stride2, SAME3x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, VALID3x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, SAME3x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      37.,  38.,  41.,  42.,  45.,  46.,  47.,  48.,  69.,  70.,  73.,  74.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow3Stride2, SAME3x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,  89.,  90.,  91.,  92.,
      93.,  94.,  95.,  96.,  137., 138., 139., 140., 145., 146., 147., 148.,
...
TYPED_TEST(MaxWindow3Stride2, VALID3x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      73.,  74.,  75.,  76.,  81.,  82.,  83.,  84.,  89.,  90.,  91.,  92.,
      137., 138., 139., 140., 145., 146., 147., 148., 153., 154., 155., 156.,
