...
using AvgWindow3Stride2 = PoolingFixture<DataType>;
TYPED_TEST_CASE(AvgWindow3Stride2, types::GTestKernelDataTypes);
TYPED_TEST(AvgWindow3Stride2, SAME1x5x5x1) {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x5x5x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x5x5x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, VALID1x5x5x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x5x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x5x5x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x5x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, VALID1x5x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x5x6x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, VALID1x5x6x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x5x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x5x6x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x5x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, VALID1x5x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x5x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x5x8x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x5x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x5x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, SAME1x6x5x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x6x5x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {7., 9., 17., 19.};
  const std::array<int, 4> in_shape = {{1, 6, 5, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x6x5x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, VALID1x6x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {13., 14., 17., 18.,
                                         33., 34., 37., 38.};
  const std::array<int, 4> in_shape = {{1, 6, 5, 2}};
...
TYPED_TEST(AvgWindow3Stride2, SAME1x6x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x6x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {25., 26., 27., 28., 33., 34.,
                                         35., 36., 65., 66., 67., 68.,
                                         73., 74., 75., 76.};
...
TYPED_TEST(AvgWindow3Stride2, SAME1x6x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, VALID1x6x6x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {8., 10., 20., 22.};
  const std::array<int, 4> in_shape = {{1, 6, 6, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x6x6x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, VALID1x6x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {15., 16., 19., 20.,
                                         39., 40., 43., 44.};
  const std::array<int, 4> in_shape = {{1, 6, 6, 2}};
...
TYPED_TEST(AvgWindow3Stride2, SAME1x6x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x6x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {29., 30., 31., 32., 37., 38.,
                                         39., 40., 77., 78., 79., 80.,
                                         85., 86., 87., 88.};
...
TYPED_TEST(AvgWindow3Stride2, SAME1x6x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, VALID1x6x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {10., 12., 14., 26., 28., 30.};
  const std::array<int, 4> in_shape = {{1, 6, 8, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x6x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x6x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {19., 20., 23., 24., 27., 28.,
                                         51., 52., 55., 56., 59., 60.};
  const std::array<int, 4> in_shape = {{1, 6, 8, 2}};
...
TYPED_TEST(AvgWindow3Stride2, SAME1x6x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      37.,  38.,  39.,  40.,  45.,  46.,  47.,  48.,  53.,  54.,  55.,  56.,
...
TYPED_TEST(AvgWindow3Stride2, VALID1x6x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      37.,  38.,  39.,  40.,  45.,  46.,  47.,  48.,  53.,  54.,  55.,  56.,
      101., 102., 103., 104., 109., 110., 111., 112., 117., 118., 119., 120.};
...
TYPED_TEST(AvgWindow3Stride2, SAME1x8x5x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x8x5x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x8x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x8x5x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x8x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      23.,  24.,  25.,  26.,  29.,  30.,  31.,  32.,  35.,  36.,  37.,  38.,
      63.,  64.,  65.,  66.,  69.,  70.,  71.,  72.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(AvgWindow3Stride2, VALID1x8x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, SAME1x8x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, VALID1x8x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x8x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x8x6x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x8x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      29.,  30.,  31.,  32.,  37.,  38.,  39.,  40.,  43.,  44.,  45.,  46.,
      77.,  78.,  79.,  80.,  85.,  86.,  87.,  88.,  91.,  92.,  93.,  94.,
...
TYPED_TEST(AvgWindow3Stride2, VALID1x8x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, SAME1x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {10., 12.,  14., 15.5, 26., 28.,
...
TYPED_TEST(AvgWindow3Stride2, VALID1x8x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME1x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {19., 20., 23., 24., 27., 28.,
                                         51., 52., 55., 56., 59., 60.,
                                         83., 84., 87., 88., 91., 92.};
...
TYPED_TEST(AvgWindow3Stride2, SAME1x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID1x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      37.,  38.,  39.,  40.,  45.,  46.,  47.,  48.,  53.,  54.,  55.,  56.,
      101., 102., 103., 104., 109., 110., 111., 112., 117., 118., 119., 120.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x5x5x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      4.,  5.5,  7.,  11.5, 13., 14.5, 19., 20.5, 22.,
      29., 30.5, 32., 36.5, 38., 39.5, 44., 45.5, 47.,
      54., 55.5, 57., 61.5, 63., 64.5, 69., 70.5, 72.,
  };
...
TYPED_TEST(AvgWindow3Stride2, VALID3x5x5x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME3x5x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID3x5x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, SAME3x5x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      13.,  14.,  15.,  16.,  19.,  20.,  21.,  22.,  25.,  26.,  27.,  28.,
      43.,  44.,  45.,  46.,  49.,  50.,  51.,  52.,  55.,  56.,  57.,  58.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x5x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      25.,  26.,  27.,  28.,  33.,  34.,  35.,  36.,  65.,  66.,  67.,  68.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x5x6x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID3x5x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME3x5x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID3x5x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, SAME3x5x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      17.,  18.,  19.,  20.,  25.,  26.,  27.,  28.,  31.,  32.,  33.,  34.,
      53.,  54.,  55.,  56.,  61.,  62.,  63.,  64.,  67.,  68.,  69.,  70.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x5x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      29.,  30.,  31.,  32.,  37.,  38.,  39.,  40.,  77.,  78.,  79.,  80.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x5x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID3x5x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {10., 12., 14., 26.,  28.,  30.,
                                         50., 52., 54., 66.,  68.,  70.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x5x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      11.,  12.,  15.,  16.,  19.,  20.,  22.,  23.,  35.,  36.,  39.,  40.,
      43.,  44.,  46.,  47.,  59.,  60.,  63.,  64.,  67.,  68.,  70.,  71.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x5x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, SAME3x5x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      21.,  22.,  23.,  24.,  29.,  30.,  31.,  32.,  37.,  38.,  39.,  40.,
      43.,  44.,  45.,  46.,  69.,  70.,  71.,  72.,  77.,  78.,  79.,  80.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x5x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      37.,  38.,  39.,  40.,  45.,  46.,  47.,  48.,  53.,  54.,  55.,  56.,
      101., 102., 103., 104., 109., 110., 111., 112., 117., 118., 119., 120.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x6x5x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      6.5,  8.,  9.5,  16.5, 18., 19.5, 24., 25.5, 27.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x6x5x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME3x6x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID3x6x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, SAME3x6x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      23.,  24.,  25.,  26.,  29.,  30.,  31.,  32.,  35.,  36.,  37.,  38.,
      63.,  64.,  65.,  66.,  69.,  70.,  71.,  72.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x6x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      25.,  26.,  27.,  28.,  33.,  34.,  35.,  36.,  65.,  66.,  67.,  68.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x6x6x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID3x6x6x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(AvgWindow3Stride2, SAME3x6x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID3x6x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, SAME3x6x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      29.,  30.,  31.,  32.,  37.,  38.,  39.,  40.,  43.,  44.,  45.,  46.,
      77.,  78.,  79.,  80.,  85.,  86.,  87.,  88.,  91.,  92.,  93.,  94.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x6x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      29.,  30.,  31.,  32.,  37.,  38.,  39.,  40.,  77.,  78.,  79.,  80.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x6x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID3x6x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {10.,  12.,  14.,  26.,  28.,  30.,
                                         58.,  60.,  62.,  74.,  76.,  78.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x6x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      19.,  20.,  23.,  24.,  27.,  28.,  30.,  31.,  51.,  52.,  55.,  56.,
      59.,  60.,  62.,  63.,  75.,  76.,  79.,  80.,  83.,  84.,  86.,  87.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x6x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      19.,  20.,  23.,  24.,  27.,  28.,  51.,  52.,  55.,  56.,  59.,  60.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x6x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      37.,  38.,  39.,  40.,  45.,  46.,  47.,  48.,  53.,  54.,  55.,  56.,
      59.,  60.,  61.,  62.,  101., 102., 103., 104., 109., 110., 111., 112.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x6x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      37.,  38.,  39.,  40.,  45.,  46.,  47.,  48.,  53.,  54.,  55.,  56.,
      101., 102., 103., 104., 109., 110., 111., 112., 117., 118., 119., 120.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x8x5x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      6.5,  8.,  9.5,  16.5, 18., 19.5, 26.5,  28.,  29.5,  34.,  35.5,  37.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x8x5x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {7.,  9.,  17., 19., 27.,  29.,
                                         47., 49., 57., 59., 67.,  69.,
                                         87., 89., 97., 99., 107., 109.};
...
TYPED_TEST(AvgWindow3Stride2, SAME3x8x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      12.,  13.,  15.,  16.,  18.,  19.,  32.,  33.,  35.,  36.,  38.,  39.,
      52.,  53.,  55.,  56.,  58.,  59.,  67.,  68.,  70.,  71.,  73.,  74.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x8x5x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, SAME3x8x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      23.,  24.,  25.,  26.,  29.,  30.,  31.,  32.,  35.,  36.,  37.,  38.,
      63.,  64.,  65.,  66.,  69.,  70.,  71.,  72.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x8x5x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      25.,  26.,  27.,  28.,  33.,  34.,  35.,  36.,  65.,  66.,  67.,  68.,
      73.,  74.,  75.,  76.,  105., 106., 107., 108., 113., 114., 115., 116.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x8x6x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID3x8x6x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {8.,   10.,  20.,  22.,  32.,  34.,
                                         56.,  58.,  68.,  70.,  80.,  82.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x8x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      15.,  16.,  19.,  20.,  22.,  23.,  39.,  40.,  43.,  44.,  46.,  47.,
      63.,  64.,  67.,  68.,  70.,  71.,  81.,  82.,  85.,  86.,  88.,  89.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x8x6x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, SAME3x8x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      29.,  30.,  31.,  32.,  37.,  38.,  39.,  40.,  43.,  44.,  45.,  46.,
      77.,  78.,  79.,  80.,  85.,  86.,  87.,  88.,  91.,  92.,  93.,  94.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x8x6x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      29.,  30.,  31.,  32.,  37.,  38.,  39.,  40.,  77.,  78.,  79.,  80.,
      85.,  86.,  87.,  88.,  125., 126., 127., 128., 133., 134., 135., 136.,
...
TYPED_TEST(AvgWindow3Stride2, SAME3x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, VALID3x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, SAME3x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      19.,  20.,  23.,  24.,  27.,  28.,  30.,  31.,  51.,  52.,  55.,  56.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(AvgWindow3Stride2, SAME3x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      37.,  38.,  39.,  40.,  45.,  46.,  47.,  48.,  53.,  54.,  55.,  56.,
      59.,  60.,  61.,  62.,  101., 102., 103., 104., 109., 110., 111., 112.,
...
TYPED_TEST(AvgWindow3Stride2, VALID3x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      37.,  38.,  39.,  40.,  45.,  46.,  47.,  48.,  53.,  54.,  55.,  56.,
      101., 102., 103., 104., 109., 110., 111., 112., 117., 118., 119., 120.,
