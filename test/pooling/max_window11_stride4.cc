...
using MaxWindow11Stride4 = PoolingFixture<DataType>;
TYPED_TEST_CASE(MaxWindow11Stride4, types::GTestKernelDataTypes);
TYPED_TEST(MaxWindow11Stride4, SAME1x15x15x1) {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x15x15x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x15x15x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, VALID1x15x15x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x15x15x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x15x15x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x15x16x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, VALID1x15x16x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x15x16x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x15x16x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x15x16x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x15x16x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x15x18x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x15x18x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x15x18x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x15x18x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x15x18x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x15x18x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, SAME1x16x15x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, VALID1x16x15x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {161., 165., 221., 225.};
  const std::array<int, 4> in_shape = {{1, 16, 15, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x16x15x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x16x15x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {321., 322., 329., 330.,
                                         441., 442., 449., 450.};
  const std::array<int, 4> in_shape = {{1, 16, 15, 2}};
...
TYPED_TEST(MaxWindow11Stride4, SAME1x16x15x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x16x15x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {641., 642., 643., 644., 657., 658.,
                                         659., 660., 881., 882., 883., 884.,
                                         897., 898., 899., 900.};
...
TYPED_TEST(MaxWindow11Stride4, SAME1x16x16x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, VALID1x16x16x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {171., 175., 235., 239.};
  const std::array<int, 4> in_shape = {{1, 16, 16, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x16x16x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x16x16x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {341., 342., 349., 350.,
                                         469., 470., 477., 478.};
  const std::array<int, 4> in_shape = {{1, 16, 16, 2}};
...
TYPED_TEST(MaxWindow11Stride4, SAME1x16x16x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x16x16x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {681., 682., 683., 684., 697., 698.,
                                         699., 700., 937., 938., 939., 940.,
                                         953., 954., 955., 956.};
...
TYPED_TEST(MaxWindow11Stride4, SAME1x16x18x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x16x18x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {191., 195., 263., 267.};
  const std::array<int, 4> in_shape = {{1, 16, 18, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x16x18x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x16x18x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {381., 382., 389., 390.,
                                         525., 526., 533., 534.};
  const std::array<int, 4> in_shape = {{1, 16, 18, 2}};
...
TYPED_TEST(MaxWindow11Stride4, SAME1x16x18x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x16x18x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      761.,  762.,  763.,  764.,  777.,  778.,  779.,  780.,
      1049., 1050., 1051., 1052., 1065., 1066., 1067., 1068.};
...
TYPED_TEST(MaxWindow11Stride4, SAME1x18x15x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x18x15x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {161., 165., 221., 225.};
  const std::array<int, 4> in_shape = {{1, 18, 15, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x18x15x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x18x15x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {321., 322., 329., 330.,
                                         441., 442., 449., 450.};
  const std::array<int, 4> in_shape = {{1, 18, 15, 2}};
...
TYPED_TEST(MaxWindow11Stride4, SAME1x18x15x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x18x15x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {641., 642., 643., 644., 657., 658.,
                                         659., 660., 881., 882., 883., 884.,
                                         897., 898., 899., 900.};
...
TYPED_TEST(MaxWindow11Stride4, SAME1x18x16x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x18x16x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {171., 175., 235., 239.};
  const std::array<int, 4> in_shape = {{1, 18, 16, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x18x16x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x18x16x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {341., 342., 349., 350.,
                                         469., 470., 477., 478.};
  const std::array<int, 4> in_shape = {{1, 18, 16, 2}};
...
TYPED_TEST(MaxWindow11Stride4, SAME1x18x16x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x18x16x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {681., 682., 683., 684., 697., 698.,
                                         699., 700., 937., 938., 939., 940.,
                                         953., 954., 955., 956.};
...
TYPED_TEST(MaxWindow11Stride4, SAME1x18x18x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID1x18x18x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {191., 195., 263., 267.};
  const std::array<int, 4> in_shape = {{1, 18, 18, 1}};
  const auto padding = PaddingMode::VALID;
...
TYPED_TEST(MaxWindow11Stride4, SAME1x18x18x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      229., 230., 237., 238., 245., 246., 251., 252., 251., 252.,
      373., 374., 381., 382., 389., 390., 395., 396., 395., 396.,
...
TYPED_TEST(MaxWindow11Stride4, VALID1x18x18x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {381., 382., 389., 390.,
                                         525., 526., 533., 534.};
  const std::array<int, 4> in_shape = {{1, 18, 18, 2}};
...
TYPED_TEST(MaxWindow11Stride4, SAME1x18x18x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      457.,  458.,  459.,  460.,  473.,  474.,  475.,  476.,  489.,  490.,
      491.,  492.,  501.,  502.,  503.,  504.,  501.,  502.,  503.,  504.,
...
TYPED_TEST(MaxWindow11Stride4, VALID1x18x18x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      761.,  762.,  763.,  764.,  777.,  778.,  779.,  780.,
      1049., 1050., 1051., 1052., 1065., 1066., 1067., 1068.};
...
TYPED_TEST(MaxWindow11Stride4, SAME3x15x15x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID3x15x15x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME3x15x15x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      193.,  194.,  201.,  202.,  209.,  210.,  209.,  210.,  313.,  314.,
      321.,  322.,  329.,  330.,  329.,  330.,  433.,  434.,  441.,  442.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x15x15x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, SAME3x15x15x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      385.,  386.,  387.,  388.,  401.,  402.,  403.,  404.,  417.,  418.,
      419.,  420.,  417.,  418.,  419.,  420.,  625.,  626.,  627.,  628.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x15x15x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, SAME3x15x16x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID3x15x16x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME3x15x16x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      207.,  208.,  215.,  216.,  223.,  224.,  223.,  224.,  335.,  336.,
      343.,  344.,  351.,  352.,  351.,  352.,  463.,  464.,  471.,  472.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x15x16x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, SAME3x15x16x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      413.,  414.,  415.,  416.,  429.,  430.,  431.,  432.,  445.,  446.,
      447.,  448.,  445.,  446.,  447.,  448.,  669.,  670.,  671.,  672.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x15x16x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, SAME3x15x18x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID3x15x18x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME3x15x18x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      229.,  230.,  237.,  238.,  245.,  246.,  251.,  252.,  251.,  252.,
      373.,  374.,  381.,  382.,  389.,  390.,  395.,  396.,  395.,  396.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x15x18x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, SAME3x15x18x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      457.,  458.,  459.,  460.,  473.,  474.,  475.,  476.,  489.,  490.,
      491.,  492.,  501.,  502.,  503.,  504.,  501.,  502.,  503.,  504.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x15x18x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, SAME3x16x15x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID3x16x15x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME3x16x15x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID3x16x15x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      321.,  322.,  329.,  330.,  441.,  442.,  449.,  450.,
...
TYPED_TEST(MaxWindow11Stride4, SAME3x16x15x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID3x16x15x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      641.,  642.,  643.,  644.,  657.,  658.,  659.,  660.,  881.,  882.,
...
TYPED_TEST(MaxWindow11Stride4, SAME3x16x16x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID3x16x16x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME3x16x16x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID3x16x16x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      341.,  342.,  349.,  350.,  469.,  470.,  477.,  478.,
...
TYPED_TEST(MaxWindow11Stride4, SAME3x16x16x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      477.,  478.,  479.,  480.,  493.,  494.,  495.,  496.,  509.,  510.,
      511.,  512.,  509.,  510.,  511.,  512.,  733.,  734.,  735.,  736.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x16x16x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      681.,  682.,  683.,  684.,  697.,  698.,  699.,  700.,  937.,  938.,
...
TYPED_TEST(MaxWindow11Stride4, SAME3x16x18x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID3x16x18x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME3x16x18x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      265.,  266.,  273.,  274.,  281.,  282.,  287.,  288.,  287.,  288.,
      409.,  410.,  417.,  418.,  425.,  426.,  431.,  432.,  431.,  432.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x16x18x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      381.,  382.,  389.,  390.,  525.,  526.,  533.,  534.,
...
TYPED_TEST(MaxWindow11Stride4, SAME3x16x18x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      529.,  530.,  531.,  532.,  545.,  546.,  547.,  548.,  561.,  562.,
      563.,  564.,  573.,  574.,  575.,  576.,  573.,  574.,  575.,  576.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x16x18x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      761.,  762.,  763.,  764.,  777.,  778.,  779.,  780.,  1049., 1050.,
...
TYPED_TEST(MaxWindow11Stride4, SAME3x18x15x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      97.,  101., 105., 105., 157., 161., 165., 165., 217., 221., 225., 225.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x18x15x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME3x18x15x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      193.,  194.,  201.,  202.,  209.,  210.,  209.,  210.,  313.,  314.,
      321.,  322.,  329.,  330.,  329.,  330.,  433.,  434.,  441.,  442.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x18x15x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      321.,  322.,  329.,  330.,  441.,  442.,  449.,  450.,
...
TYPED_TEST(MaxWindow11Stride4, SAME3x18x15x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      385.,  386.,  387.,  388.,  401.,  402.,  403.,  404.,  417.,  418.,
      419.,  420.,  417.,  418.,  419.,  420.,  625.,  626.,  627.,  628.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x18x15x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      641.,  642.,  643.,  644.,  657.,  658.,  659.,  660.,  881.,  882.,
...
TYPED_TEST(MaxWindow11Stride4, SAME3x18x16x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      104., 108., 112., 112., 168., 172., 176., 176., 232., 236., 240., 240.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x18x16x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME3x18x16x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      207.,  208.,  215.,  216.,  223.,  224.,  223.,  224.,  335.,  336.,
      343.,  344.,  351.,  352.,  351.,  352.,  463.,  464.,  471.,  472.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x18x16x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      341.,  342.,  349.,  350.,  469.,  470.,  477.,  478.,
...
TYPED_TEST(MaxWindow11Stride4, SAME3x18x16x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      413.,  414.,  415.,  416.,  429.,  430.,  431.,  432.,  445.,  446.,
      447.,  448.,  445.,  446.,  447.,  448.,  669.,  670.,  671.,  672.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x18x16x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      681.,  682.,  683.,  684.,  697.,  698.,  699.,  700.,  937.,  938.,
...
TYPED_TEST(MaxWindow11Stride4, SAME3x18x18x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow11Stride4, VALID3x18x18x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow11Stride4, SAME3x18x18x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      229.,  230.,  237.,  238.,  245.,  246.,  251.,  252.,  251.,  252.,
      373.,  374.,  381.,  382.,  389.,  390.,  395.,  396.,  395.,  396.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x18x18x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      381.,  382.,  389.,  390.,  525.,  526.,  533.,  534.,
...
TYPED_TEST(MaxWindow11Stride4, SAME3x18x18x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      457.,  458.,  459.,  460.,  473.,  474.,  475.,  476.,  489.,  490.,
      491.,  492.,  501.,  502.,  503.,  504.,  501.,  502.,  503.,  504.,
...
TYPED_TEST(MaxWindow11Stride4, VALID3x18x18x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      761.,  762.,  763.,  764.,  777.,  778.,  779.,  780.,  1049., 1050.,
