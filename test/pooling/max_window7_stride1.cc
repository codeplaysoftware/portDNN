...
using MaxWindow7Stride1 = PoolingFixture<DataType>;
TYPED_TEST_CASE(MaxWindow7Stride1, types::GTestKernelDataTypes);
TYPED_TEST(MaxWindow7Stride1, SAME1x8x8x1) {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x8x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride1, SAME1x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x8x8x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride1, SAME1x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x8x8x4) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride1, SAME1x8x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x8x9x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride1, SAME1x8x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x8x9x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride1, SAME1x8x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x8x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      241., 242., 243., 244., 245., 246., 247., 248., 249., 250., 251., 252.,
      277., 278., 279., 280., 281., 282., 283., 284., 285., 286., 287., 288.};
...
TYPED_TEST(MaxWindow7Stride1, SAME1x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x8x10x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride1, SAME1x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x8x10x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride1, SAME1x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 137., 138., 139., 140., 141., 142., 143., 144.,
      145., 146., 147., 148., 149., 150., 151., 152., 153., 154., 155., 156.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME1x9x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x9x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride1, SAME1x9x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  59.,  60.,  61.,  62.,  63.,  64.,  63.,  64.,
      63.,  64.,  63.,  64.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x9x8x2) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride1, SAME1x9x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      109., 110., 111., 112., 113., 114., 115., 116., 117., 118., 119., 120.,
      121., 122., 123., 124., 125., 126., 127., 128., 125., 126., 127., 128.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x9x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME1x9x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x9x9x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride1, SAME1x9x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      61.,  62.,  63.,  64.,  65.,  66.,  67.,  68.,  69.,  70.,  71.,  72.,
      71.,  72.,  71.,  72.,  71.,  72.,  79.,  80.,  81.,  82.,  83.,  84.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x9x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {121., 122., 123., 124., 125., 126.,
                                         139., 140., 141., 142., 143., 144.,
...
TYPED_TEST(MaxWindow7Stride1, SAME1x9x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 123., 124., 125., 126., 127., 128., 129., 130., 131., 132.,
      133., 134., 135., 136., 137., 138., 139., 140., 141., 142., 143., 144.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x9x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      241., 242., 243., 244., 245., 246., 247., 248., 249., 250., 251., 252.,
      277., 278., 279., 280., 281., 282., 283., 284., 285., 286., 287., 288.,
...
TYPED_TEST(MaxWindow7Stride1, SAME1x9x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x9x10x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride1, SAME1x9x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
      79.,  80.,  79.,  80.,  79.,  80.,  79.,  80.,  87.,  88.,  89.,  90.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x9x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME1x9x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 137., 138., 139., 140., 141., 142., 143., 144.,
      145., 146., 147., 148., 149., 150., 151., 152., 153., 154., 155., 156.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x9x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      265., 266., 267., 268., 269., 270., 271., 272., 273., 274., 275., 276.,
...
TYPED_TEST(MaxWindow7Stride1, SAME1x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {55., 56., 63., 64.,
                                         71., 72., 79., 80.};
  const std::array<int, 4> in_shape = {{1, 10, 8, 1}};
...
TYPED_TEST(MaxWindow7Stride1, SAME1x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  59.,  60.,  61.,  62.,  63.,  64.,  63.,  64.,
      63.,  64.,  63.,  64.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {109., 110., 111., 112., 125., 126.,
                                         127., 128., 141., 142., 143., 144.,
                                         157., 158., 159., 160.};
...
TYPED_TEST(MaxWindow7Stride1, SAME1x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      109., 110., 111., 112., 113., 114., 115., 116., 117., 118., 119., 120.,
      121., 122., 123., 124., 125., 126., 127., 128., 125., 126., 127., 128.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME1x10x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x10x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {61., 62., 63., 70., 71., 72.,
                                         79., 80., 81., 88., 89., 90.};
  const std::array<int, 4> in_shape = {{1, 10, 9, 1}};
...
TYPED_TEST(MaxWindow7Stride1, SAME1x10x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      61.,  62.,  63.,  64.,  65.,  66.,  67.,  68.,  69.,  70.,  71.,  72.,
      71.,  72.,  71.,  72.,  71.,  72.,  79.,  80.,  81.,  82.,  83.,  84.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x10x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME1x10x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 123., 124., 125., 126., 127., 128., 129., 130., 131., 132.,
      133., 134., 135., 136., 137., 138., 139., 140., 141., 142., 143., 144.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x10x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      241., 242., 243., 244., 245., 246., 247., 248., 249., 250., 251., 252.,
      277., 278., 279., 280., 281., 282., 283., 284., 285., 286., 287., 288.,
...
TYPED_TEST(MaxWindow7Stride1, SAME1x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID1x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {67., 68., 69., 70., 77., 78.,
                                         79., 80., 87., 88., 89., 90.,
                                         97., 98., 99., 100.};
...
TYPED_TEST(MaxWindow7Stride1, SAME1x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
      79.,  80.,  79.,  80.,  79.,  80.,  79.,  80.,  87.,  88.,  89.,  90.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME1x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 137., 138., 139., 140., 141., 142., 143., 144.,
      145., 146., 147., 148., 149., 150., 151., 152., 153., 154., 155., 156.,
...
TYPED_TEST(MaxWindow7Stride1, VALID1x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      265., 266., 267., 268., 269., 270., 271., 272., 273., 274., 275.,
      276., 277., 278., 279., 280., 305., 306., 307., 308., 309., 310.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x8x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID3x8x8x1) {
  using DataType = typename TestFixture::DataType;
...
TYPED_TEST(MaxWindow7Stride1, SAME3x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  59.,  60.,  61.,  62.,  63.,  64.,  63.,  64.,
      63.,  64.,  63.,  64.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x8x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME3x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      109., 110., 111., 112., 113., 114., 115., 116., 117., 118., 119., 120.,
      121., 122., 123., 124., 125., 126., 127., 128., 125., 126., 127., 128.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x8x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      217., 218., 219., 220., 221., 222., 223., 224., 249., 250., 251., 252.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x8x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID3x8x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {61.,  62.,  63.,  70.,  71.,  72.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x8x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      61.,  62.,  63.,  64.,  65.,  66.,  67.,  68.,  69.,  70.,  71.,  72.,
      71.,  72.,  71.,  72.,  71.,  72.,  79.,  80.,  81.,  82.,  83.,  84.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x8x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 123., 124., 125., 126., 139., 140., 141., 142., 143., 144.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x8x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 123., 124., 125., 126., 127., 128., 129., 130., 131., 132.,
      133., 134., 135., 136., 137., 138., 139., 140., 141., 142., 143., 144.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x8x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      241., 242., 243., 244., 245., 246., 247., 248., 249., 250., 251., 252.,
      277., 278., 279., 280., 281., 282., 283., 284., 285., 286., 287., 288.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      34.,  35.,  36.,  37.,  38.,  39.,  40.,  40.,  40.,  40.,  44.,  45.,
      46.,  47.,  48.,  49.,  50.,  50.,  50.,  50.,  54.,  55.,  56.,  57.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x8x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME3x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
      79.,  80.,  79.,  80.,  79.,  80.,  79.,  80.,  87.,  88.,  89.,  90.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x8x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 137., 138., 139., 140., 153., 154., 155., 156.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 137., 138., 139., 140., 141., 142., 143., 144.,
      145., 146., 147., 148., 149., 150., 151., 152., 153., 154., 155., 156.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x8x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      265., 266., 267., 268., 269., 270., 271., 272., 273., 274., 275., 276.,
      277., 278., 279., 280., 305., 306., 307., 308., 309., 310., 311., 312.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x9x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      28.,  29.,  30.,  31.,  32.,  32.,  32.,  32.,  36.,  37.,  38.,  39.,
      40.,  40.,  40.,  40.,  44.,  45.,  46.,  47.,  48.,  48.,  48.,  48.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x9x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {55.,  56.,  63.,  64.,  71.,  72.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x9x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  59.,  60.,  61.,  62.,  63.,  64.,  63.,  64.,
      63.,  64.,  63.,  64.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x9x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME3x9x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      109., 110., 111., 112., 113., 114., 115., 116., 117., 118., 119., 120.,
      121., 122., 123., 124., 125., 126., 127., 128., 125., 126., 127., 128.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x9x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      217., 218., 219., 220., 221., 222., 223., 224., 249., 250., 251., 252.,
      253., 254., 255., 256., 281., 282., 283., 284., 285., 286., 287., 288.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x9x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      31.,  32.,  33.,  34.,  35.,  36.,  36.,  36.,  36.,  40.,  41.,  42.,
      43.,  44.,  45.,  45.,  45.,  45.,  49.,  50.,  51.,  52.,  53.,  54.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x9x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME3x9x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      61.,  62.,  63.,  64.,  65.,  66.,  67.,  68.,  69.,  70.,  71.,  72.,
      71.,  72.,  71.,  72.,  71.,  72.,  79.,  80.,  81.,  82.,  83.,  84.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x9x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME3x9x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 123., 124., 125., 126., 127., 128., 129., 130., 131., 132.,
      133., 134., 135., 136., 137., 138., 139., 140., 141., 142., 143., 144.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x9x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      241., 242., 243., 244., 245., 246., 247., 248., 249., 250., 251., 252.,
      277., 278., 279., 280., 281., 282., 283., 284., 285., 286., 287., 288.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x9x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      34.,  35.,  36.,  37.,  38.,  39.,  40.,  40.,  40.,  40.,  44.,  45.,
      46.,  47.,  48.,  49.,  50.,  50.,  50.,  50.,  54.,  55.,  56.,  57.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x9x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME3x9x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
      79.,  80.,  79.,  80.,  79.,  80.,  79.,  80.,  87.,  88.,  89.,  90.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x9x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 137., 138., 139., 140., 153., 154., 155., 156.,
      157., 158., 159., 160., 173., 174., 175., 176., 177., 178., 179., 180.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x9x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID3x9x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME3x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      28.,  29.,  30.,  31.,  32.,  32.,  32.,  32.,  36.,  37.,  38.,  39.,
      40.,  40.,  40.,  40.,  44.,  45.,  46.,  47.,  48.,  48.,  48.,  48.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x10x8x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME3x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      55.,  56.,  57.,  58.,  59.,  60.,  61.,  62.,  63.,  64.,  63.,  64.,
      63.,  64.,  63.,  64.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x10x8x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      109., 110., 111., 112., 125., 126., 127., 128., 141., 142., 143., 144.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      109., 110., 111., 112., 113., 114., 115., 116., 117., 118., 119., 120.,
      121., 122., 123., 124., 125., 126., 127., 128., 125., 126., 127., 128.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x10x8x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      217., 218., 219., 220., 221., 222., 223., 224., 249., 250., 251., 252.,
      253., 254., 255., 256., 281., 282., 283., 284., 285., 286., 287., 288.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x10x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      31.,  32.,  33.,  34.,  35.,  36.,  36.,  36.,  36.,  40.,  41.,  42.,
      43.,  44.,  45.,  45.,  45.,  45.,  49.,  50.,  51.,  52.,  53.,  54.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x10x9x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, SAME3x10x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      61.,  62.,  63.,  64.,  65.,  66.,  67.,  68.,  69.,  70.,  71.,  72.,
      71.,  72.,  71.,  72.,  71.,  72.,  79.,  80.,  81.,  82.,  83.,  84.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x10x9x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      121., 122., 123., 124., 125., 126., 139., 140., 141., 142., 143., 144.,
      157., 158., 159., 160., 161., 162., 175., 176., 177., 178., 179., 180.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x10x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
...
TYPED_TEST(MaxWindow7Stride1, VALID3x10x9x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      241.,  242.,  243.,  244.,  245.,  246.,  247.,  248.,  249.,  250.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      34.,  35.,  36.,  37.,  38.,  39.,  40.,  40.,  40.,  40.,  44.,  45.,
      46.,  47.,  48.,  49.,  50.,  50.,  50.,  50.,  54.,  55.,  56.,  57.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x10x10x1) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  77.,  78.,  79.,  80.,  87.,  88.,  89.,  90.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      67.,  68.,  69.,  70.,  71.,  72.,  73.,  74.,  75.,  76.,  77.,  78.,
      79.,  80.,  79.,  80.,  79.,  80.,  79.,  80.,  87.,  88.,  89.,  90.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x10x10x2) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133., 134., 135., 136., 137., 138., 139., 140., 153., 154., 155., 156.,
      157., 158., 159., 160., 173., 174., 175., 176., 177., 178., 179., 180.,
...
TYPED_TEST(MaxWindow7Stride1, SAME3x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      133.,  134.,  135.,  136.,  137.,  138.,  139.,  140.,  141.,  142.,
      143.,  144.,  145.,  146.,  147.,  148.,  149.,  150.,  151.,  152.,
...
TYPED_TEST(MaxWindow7Stride1, VALID3x10x10x4) {
  using DataType = typename TestFixture::DataType;
  const std::vector<DataType> exp_out = {
      265.,  266.,  267.,  268.,  269.,  270.,  271.,  272.,  273.,  274.,
      275.,  276.,  277.,  278.,  279.,  280.,  305.,  306.,  307.,  308.,
