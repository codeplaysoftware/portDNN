...
# License.
# See https://github.com/triSYCL/triSYCL/blob/master/LICENSE.TXT for details.
...
#
# Requires CMake version 3.5 or higher

# Original version can be found at
#   https://github.com/triSYCL/triSYCL/blob/master/cmake/FindTriSYCL.cmake
...
function(add_sycl_to_target)
  ...
  target_include_directories (${SNN_ADD_SYCL_TARGET} PUBLIC
    ${TRISYCL_INCLUDE_DIR}
    ${Boost_INCLUDE_DIRS}
  ...
  # Link dependencies
  target_link_libraries(${SNN_ADD_SYCL_TARGET} PUBLIC
  ...
  # Compile definitions
  target_compile_definitions(${SNN_ADD_SYCL_TARGET} PUBLIC
