...
if(SNN_DOWNLOAD_GTEST OR (NOT GTEST_FOUND AND SNN_DOWNLOAD_MISSING_DEPS))
  ...
  set(GTEST_CONFIG_SUFFIX "")
  if (${CMAKE_BUILD_TYPE} STREQUAL "Debug")
    set(GTEST_CONFIG_SUFFIX "d")
  endif()
  set(GTEST_SOURCE_DIR ${snn_tests_BINARY_DIR}/googletest-src)
  set(GTEST_BINARY_DIR ${snn_tests_BINARY_DIR}/googletest-build)
  set(GTEST_LIBNAME ${CMAKE_STATIC_LIBRARY_PREFIX}gtest${GTEST_CONFIG_SUFFIX}${CMAKE_STATIC_LIBRARY_SUFFIX})
  set(GTEST_MAIN_LIBNAME ${CMAKE_STATIC_LIBRARY_PREFIX}gtest_main${GTEST_CONFIG_SUFFIX}${CMAKE_STATIC_LIBRARY_SUFFIX})
