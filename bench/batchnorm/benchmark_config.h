 ...
 */
#ifndef PORTDNN_BENCH_BATCHNORM_BENCHMARK_CONFIG_H_
#define PORTDNN_BENCH_BATCHNORM_BENCHMARK_CONFIG_H_
...
/**
 * Provide a set of batchnorm benchmark configurations.
 *
 ...
 * the benchmark State. A set of sycldnn::batchnorm::BatchNormParams can be
...
#endif  // PORTDNN_BENCH_BATCHNORM_BENCHMARK_CONFIG_H_
