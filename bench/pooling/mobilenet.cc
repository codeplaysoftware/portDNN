...
#define MOBILENET_PARAMS(C, H, W, K, S, PAD) CONFIG(1, C, H, W, K, S, PAD),
#include "bench/pooling/mobilenet_params.def"
#undef MOBILENET_PARAMS

#define MOBILENET_PARAMS(C, H, W, K, S, PAD) CONFIG(4, C, H, W, K, S, PAD),
#include "bench/pooling/mobilenet_params.def"
#undef MOBILENET_PARAMS

#ifdef SNN_LARGE_BATCH_BENCHMARKS
#define MOBILENET_PARAMS(C, H, W, K, S, PAD) CONFIG(32, C, H, W, K, S, PAD),
#include "bench/pooling/mobilenet_params.def"
#undef MOBILENET_PARAMS
...
#define MOBILENET_PARAMS(C, H, W, K, S, PAD) CONFIG(2, C, H, W, K, S, PAD),
#include "bench/pooling/mobilenet_params.def"
#undef MOBILENET_PARAMS

#ifdef SNN_LARGE_BATCH_BENCHMARKS
#define MOBILENET_PARAMS(C, H, W, K, S, PAD) CONFIG(8, C, H, W, K, S, PAD),
#include "bench/pooling/mobilenet_params.def"
#undef MOBILENET_PARAMS

#define MOBILENET_PARAMS(C, H, W, K, S, PAD) CONFIG(16, C, H, W, K, S, PAD),
#include "bench/pooling/mobilenet_params.def"
#undef MOBILENET_PARAMS

#define MOBILENET_PARAMS(C, H, W, K, S, PAD) CONFIG(64, C, H, W, K, S, PAD),
#include "bench/pooling/mobilenet_params.def"
#undef MOBILENET_PARAMS
#endif  // SNN_LARGE_BATCH_BENCHMARKS
