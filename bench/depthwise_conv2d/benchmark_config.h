 ...
 */
#ifndef PORTDNN_BENCH_DEPTHWISE_CONV2D_BENCHMARK_CONFIG_H_
#define PORTDNN_BENCH_DEPTHWISE_CONV2D_BENCHMARK_CONFIG_H_
...
/**
 * Provide a set of depthwise convolution benchmark configurations.
 *
 ...
 * the benchmark State. A set of
 * sycldnn::depthwise_conv2d::DepthwiseConv2dParams can be
...
#endif  // PORTDNN_BENCH_DEPTHWISE_CONV2D_BENCHMARK_CONFIG_H_
