 ...
 */
#ifndef SYCLDNN_BENCH_FIXTURE_ADD_SYCL_DEVICE_INFO_H_
#define SYCLDNN_BENCH_FIXTURE_ADD_SYCL_DEVICE_INFO_H_
...
#endif  // SYCLDNN_BENCH_FIXTURE_ADD_SYCL_DEVICE_INFO_H_
