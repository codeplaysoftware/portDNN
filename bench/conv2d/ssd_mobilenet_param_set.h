 ...
 */
#ifndef SYCLDNN_BENCH_CONV2D_SSD_MOBILENET_PARAM_SET_H_
#define SYCLDNN_BENCH_CONV2D_SSD_MOBILENET_PARAM_SET_H_
...
struct ParameterSet {
  sycldnn::conv2d::Conv2DParams operator()() {
    ...
    params.pad_rows = Padding;
    params.pad_cols = Padding;
...
#endif  // SYCLDNN_BENCH_CONV2D_SSD_MOBILENET_PARAM_SET_H_
