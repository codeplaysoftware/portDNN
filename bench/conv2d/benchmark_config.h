 ...
 */
#ifndef PORTDNN_BENCH_CONV2D_BENCHMARK_CONFIG_H_
#define PORTDNN_BENCH_CONV2D_BENCHMARK_CONFIG_H_
...
/**
 * Provide a set of convolution benchmark configurations.
 *
 ...
 * the benchmark State. A set of sycldnn::conv2d::Conv2dParams can be
...
#endif  // PORTDNN_BENCH_CONV2D_BENCHMARK_CONFIG_H_
