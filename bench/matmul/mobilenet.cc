...
char const* matmul_benchmark_name() { return "Mobilenet V1 Network Matmuls"; }

#define MOBILENET_PARAMS(M, K, N, BATCH, TRANS_L, TRANS_R) \
...
#include "bench/matmul/mobilenet_params.def"
  };
  return configs;
}
