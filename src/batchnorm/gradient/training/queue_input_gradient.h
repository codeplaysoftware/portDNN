...
#ifndef SYCLDNN_SRC_INPUT_GRADIENT_TRAINING_QUEUE_BATCHNORM_H
#define SYCLDNN_SRC_INPUT_GRADIENT_TRAINING_QUEUE_BATCHNORM_H
...
#endif  // SYCLDNN_SRC_INPUT_GRADIENT_TRAINING_QUEUE_BATCHNORM_H
