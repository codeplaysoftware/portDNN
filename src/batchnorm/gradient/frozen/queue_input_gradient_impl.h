...
#ifndef SYCLDNN_SRC_INPUT_GRADIENT_FROZEN_QUEUE_IMPL_H
#define SYCLDNN_SRC_INPUT_GRADIENT_FROZEN_QUEUE_IMPL_H
...
SNNStatus queue_input_gradient(BaseMemObject<T const>& gradient,
  ...
  auto event = queue.submit([&](cl::sycl::handler& cgh) {
    ...
    InputGradientFrozen<T, Index, VectorWidth> op{
        gradient_acc, gamma_acc, variance_acc, output_acc, n_vecs, epsilon};
...
#endif  // SYCLDNN_SRC_INPUT_GRADIENT_FROZEN_QUEUE_IMPL_H
