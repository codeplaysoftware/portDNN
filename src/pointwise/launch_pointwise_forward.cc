...
#elif defined ENABLE_SOFTMAXDIV
SNN_INSTANTIATE_LAUNCH_POINTWISE_KERNEL(float, Exp)
SNN_INSTANTIATE_LAUNCH_POINTWISE_KERNEL(float, SoftMaxDiv)
#else
...
SNN_INSTANTIATE_LAUNCH_POINTWISE_KERNEL(cl::sycl::half, SoftMaxDiv)
#else
...
SNN_INSTANTIATE_LAUNCH_POINTWISE_KERNEL(double, SoftMaxDiv)
#else
