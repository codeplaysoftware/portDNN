...
struct TransformedInputTile<T, 3, 3, 3, 3> final
  ...
  SNN_ALWAYS_INLINE explicit TransformedInputTile(
    ...
    data[0][0] =
        inp.data[1][1] - inp.data[1][3] - inp.data[3][1] + inp.data[3][3] +
        (-inp.data[0][1] + inp.data[0][3] - inp.data[1][0] + inp.data[1][2] +
    ...
    data[0][4] =
        ...
        (-inp.data[0][2] + inp.data[0][4] - inp.data[1][1] + inp.data[1][3] +
    ...
    data[1][1] =
        ...
        (inp.data[1][2] - inp.data[1][3] + inp.data[2][1] - inp.data[3][1]) *
            2 +
        inp.data[1][1] * 4;
    data[1][2] = -inp.data[2][3] + inp.data[3][3] +
                 (-inp.data[1][3] - inp.data[2][1] + inp.data[3][1]) * 2 +
    ...
    data[2][0] =
        -inp.data[3][1] + inp.data[3][3] +
        (-inp.data[1][1] + inp.data[1][3] + inp.data[3][0] - inp.data[3][2]) *
            2 +
        (inp.data[2][1] - inp.data[2][3]) * 3 +
        (inp.data[1][0] - inp.data[1][2]) * 4 +
        (-inp.data[2][0] + inp.data[2][2]) * 6;
    data[2][1] = -inp.data[3][2] + inp.data[3][3] +
                 (-inp.data[1][2] + inp.data[1][3] - inp.data[3][1]) * 2 +
    ...
    data[2][3] = -inp.data[3][1] + inp.data[3][3] +
                 (-inp.data[1][1] + inp.data[1][3]) * 2 +
                 (inp.data[2][1] - inp.data[2][3]) * 3;
    data[2][4] =
        -inp.data[3][2] + inp.data[3][4] +
        (-inp.data[1][2] + inp.data[1][4] + inp.data[3][1] - inp.data[3][3]) *
            2 +
        (inp.data[2][2] - inp.data[2][4]) * 3 +
        (inp.data[1][1] - inp.data[1][3]) * 4 +
        (-inp.data[2][1] + inp.data[2][3]) * 6;
    ...
    data[3][2] = -inp.data[1][3] + inp.data[3][3] +
                 (-inp.data[1][1] + inp.data[3][1]) * 2 +
                 (inp.data[1][2] - inp.data[3][2]) * 3;
    data[3][3] =
        inp.data[1][1] - inp.data[1][3] - inp.data[3][1] + inp.data[3][3];
    data[3][4] =
    ...
    data[4][0] =
        ...
        (-inp.data[1][1] + inp.data[1][3] - inp.data[2][0] + inp.data[2][2] +
    ...
    data[4][4] =
        ...
        (-inp.data[1][2] + inp.data[1][4] - inp.data[2][1] + inp.data[2][3] +
...
struct TransformedInputTile<T, 4, 4, 3, 3> final
  ...
  SNN_ALWAYS_INLINE explicit TransformedInputTile(
    ...
    data[0][2] = -input.data[4][3] + input.data[4][4] +
    ...
    data[0][3] = -input.data[4][2] + input.data[4][4] +
    ...
    data[0][4] = -input.data[4][2] + input.data[4][4] +
    ...
    data[1][1] = input.data[3][3] + input.data[3][4] + input.data[4][3] +
                 ...
                 (input.data[1][1] + input.data[1][2] + input.data[2][1] +
                  input.data[2][2]) *
                     16;
    data[1][2] = -input.data[3][3] + input.data[3][4] - input.data[4][3] +
                 input.data[4][4] +
                 (input.data[1][3] - input.data[1][4] + input.data[2][3] -
                  input.data[2][4] + input.data[3][1] - input.data[3][2] +
                  input.data[4][1] - input.data[4][2]) *
                 ...
                 (input.data[1][2] - input.data[1][1] - input.data[2][1] +
                  input.data[2][2]) *
                     16;
    data[1][3] = -input.data[3][2] + input.data[3][4] - input.data[4][2] +
                 input.data[4][4] +
                 ...
                 (input.data[1][1] - input.data[1][3] + input.data[2][1] -
                  input.data[2][3]) *
                     8;
    data[1][4] = -input.data[3][2] + input.data[3][4] - input.data[4][2] +
                 input.data[4][4] +
    ...
    data[2][0] = -input.data[3][4] + input.data[4][4] +
    ...
    data[2][1] = -input.data[3][3] - input.data[3][4] + input.data[4][3] +
                 input.data[4][4] +
                 (input.data[1][3] + input.data[1][4] - input.data[2][3] -
                  input.data[2][4] + input.data[3][1] + input.data[3][2] -
                  input.data[4][1] - input.data[4][2]) *
    ...
    data[2][4] = input.data[3][2] - input.data[3][4] - input.data[4][2] +
                 ...
                 (input.data[1][1] - input.data[1][3] - input.data[2][1] +
                  input.data[2][3]) *
                     8;
    data[2][5] = -input.data[3][5] + input.data[4][5] +
    ...
    data[3][0] = -input.data[2][4] + input.data[4][4] +
    ...
    data[3][1] = -input.data[2][3] - input.data[2][4] + input.data[4][3] +
                 input.data[4][4] +
    ...
    data[3][4] = input.data[2][2] - input.data[2][4] - input.data[4][2] +
                 ...
                 (input.data[1][3] - input.data[1][1] + input.data[3][1] -
                  input.data[3][3]) *
                     4;
    data[3][5] = -input.data[2][5] + input.data[4][5] +
    ...
    data[4][4] = input.data[2][2] - input.data[2][4] - input.data[4][2] +
                 ...
                 (input.data[1][1] - input.data[1][3] - input.data[3][1] +
                  input.data[3][3]) *
                     4;
    data[4][5] = -input.data[2][5] + input.data[4][5] +
    ...
    data[5][2] = -input.data[5][3] + input.data[5][4] +
    ...
    data[5][3] = -input.data[5][2] + input.data[5][4] +
    ...
    data[5][4] = -input.data[5][2] + input.data[5][4] +
