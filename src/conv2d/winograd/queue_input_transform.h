 ...
 */
#ifndef PORTDNN_SRC_CONV2D_WINOGRAD_QUEUE_INPUT_TRANSFORM_H_
#define PORTDNN_SRC_CONV2D_WINOGRAD_QUEUE_INPUT_TRANSFORM_H_
...
SNNStatus queue_input_transform(MemObj<T const>& input, MemObj<T>& in_transform,
